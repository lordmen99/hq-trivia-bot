...
class TestTimeSeriesDuplicates(unittest.TestCase):
    ...
    def test_constructor(self):
        self.assertTrue(isinstance(self.dups, TimeSeries))
        self.assertTrue(isinstance(self.dups.index, DatetimeIndex))

    def test_is_unique_monotonic(self):
        self.assertTrue(not self.dups.index.is_unique)

    def test_index_unique(self):
        uniques = self.dups.index.unique()
        self.assertTrue(uniques.dtype == 'M8[ns]')  # sanity
    ...
    def test_indexing_over_size_cutoff(self):
        ...
        try:
            ...
            self.assertTrue(timestamp in df.index)
...
class TestTimeSeries(unittest.TestCase):
    ...
    def test_dti_slicing(self):
        ...
        self.assertTrue(dti2.freq is None)
    ...
    def test_pass_datetimeindex_to_index(self):
        ...
        self.assertTrue(np.array_equal(idx.values, expected.values))
    ...
    def test_contiguous_boolean_preserve_freq(self):
        ...
        masked = rng[mask]
        expected = rng[10:20]
        self.assertTrue(expected.freq is not None)
        assert_range_equal(masked, expected)

        mask[22] = True
        masked = rng[mask]
        self.assertTrue(masked.freq is None)
    ...
    def test_series_box_timestamp(self):
        ...
        self.assertTrue(isinstance(s[5], Timestamp))

        rng = date_range('20090415', '20090519', freq='B')
        s = Series(rng, index=rng)
        self.assertTrue(isinstance(s[5], Timestamp))

        self.assertTrue(isinstance(s.iget_value(5), Timestamp))
    ...
    def test_index_convert_to_datetime_array(self):
        ...
        def _check_rng(rng):
            ...
            for x, stamp in zip(converted, rng):
                self.assertTrue(type(x) is datetime)
    ...
    def test_ctor_str_intraday(self):
        ...
        self.assertTrue(rng[0].second == 1)
    ...
    def test_series_ctor_plus_datetimeindex(self):
        ...
        self.assertTrue(result.index is rng)
    ...
    def test_frame_add_datetime64_col_other_units(self):
        ...
        for unit in units:
            ...
            self.assertTrue(df[unit].dtype == ns_dtype)
    ...
    def test_index_astype_datetime64(self):
        ...
        self.assertTrue(isinstance(casted, DatetimeIndex))
    ...
    def test_reindex_series_add_nat(self):
        ...
        self.assertTrue(not mask[:-5].any())
    ...
    def test_string_na_nat_conversion(self):
        ...
        self.assertTrue(isinstance(result2, DatetimeIndex))
    ...
    def test_to_datetime_freq(self):
        ...
        rs = xp.to_datetime()
        self.assertTrue(xp.freq == rs.freq)
        self.assertTrue(xp.tzinfo == rs.tzinfo)
    ...
    def test_repeat(self):
        ...
        self.assertTrue(len(result) == 5 * len(rng))
    ...
    def test_between_time(self):
        ...
        for inc_start, inc_end in close_open:
            ...
            self.assertTrue(len(filtered) == exp_len)
    ...
    def test_dti_constructor_preserve_dti_freq(self):
        ...
        self.assertTrue(rng.freq == rng2.freq)
    ...
    def test_normalize(self):
        ...
        self.assertTrue(not rng.is_normalized)
    ...
    def test_timestamp_repr(self):
        ...
        result = repr(stamp)
        self.assertTrue(iso8601 in result)
    ...
    def test_timestamp_from_ordinal(self):
        ...
        self.assertTrue(ts.to_pydatetime() == dt)

        # with a tzinfo
        stamp = Timestamp('2011-4-16', tz='US/Eastern')
        dt_tz = stamp.to_pydatetime()
        ts = Timestamp.fromordinal(dt_tz.toordinal(),tz='US/Eastern')
        self.assertTrue(ts.to_pydatetime() == dt_tz)
    ...
    def test_astype_object(self):
        ...
        self.assertTrue(np.array_equal(casted, exp_values))
    ...
    def test_append_concat(self):
        ...
        rng1.name = 'foo'
        rng2.name = 'bar'
        self.assertTrue(rng1.append(rng1).name == 'foo')
        self.assertTrue(rng1.append(rng2).name is None)
    ...
    def test_set_dataframe_column_ns_dtype(self):
        ...
        self.assertTrue(x[0].dtype == np.dtype('M8[ns]'))
    ...
    def test_series_interpolate_intraday(self):
        ...
        self.assertTrue(np.array_equal(result.values, exp.values))
    ...
    def test_timestamp_compare_with_early_datetime(self):
        ...
        self.assertTrue(stamp != datetime.min)
    ...
    def test_to_html_timestamp(self):
        ...
        result = df.to_html()
        self.assertTrue('2000-01-01' in result)
...
class TestDatetimeIndex(unittest.TestCase):
    ...
    def test_append_join_nondatetimeindex(self):
        ...
        self.assertTrue(isinstance(result[0], Timestamp))
    ...
    def test_astype(self):
        ...
        self.assertTrue(np.array_equal(result, rng.asi8))
    ...
    def test_000constructor_resolution(self):
        ...
        self.assertTrue(idx.nanosecond[0] == t1.nanosecond)
    ...
    def test_comparisons_coverage(self):
        ...
        result = rng == list(rng)
        exp = rng == rng
        self.assertTrue(np.array_equal(result, exp))
    ...
    def test_misc_coverage(self):
        ...
        self.assertTrue(isinstance(list(result.values())[0][0], Timestamp))

        idx = DatetimeIndex(['2000-01-03', '2000-01-01', '2000-01-02'])
        self.assertTrue(idx.equals(list(idx)))

        non_datetime = Index(list('abc'))
        self.assertTrue(not idx.equals(list(non_datetime)))
    ...
    def test_union_coverage(self):
        ...
        self.assertTrue(result.equals(ordered))
        self.assertTrue(result.freq == ordered.freq)
    ...
    def test_order(self):
        ...
        self.assertTrue(ordered.is_monotonic)
        self.assertTrue(np.array_equal(dexer, [1, 2, 0]))

        ordered, dexer = idx.order(return_indexer=True, ascending=False)
        self.assertTrue(ordered[::-1].is_monotonic)
        self.assertTrue(np.array_equal(dexer, [0, 2, 1]))
    ...
    def test_insert(self):
        ...
        self.assertTrue(result.freqstr == 'M')
    ...
    def test_groupby_function_tuple_1677(self):
        ...
        self.assertTrue(isinstance(result.index[0], tuple))
...
class TestLegacySupport(unittest.TestCase):
    ...
    def test_unpickle_legacy_len0_daterange(self):
        ...
        self.assertTrue(result.index.equals(ex_index))
        self.assertTrue(isinstance(result.index.freq, offsets.BDay))
    ...
    def test_arithmetic_interaction(self):
        ...
        expected = dseries * 2
        self.assertTrue(isinstance(result.index, DatetimeIndex))
        assert_series_equal(result, expected)
    ...
    def test_join_interaction(self):
        ...
        def _check_join(left, right, how='inner'):
            ...
            self.assertTrue(isinstance(ra, DatetimeIndex))
    ...
    def test_unpickle_daterange(self):
        ...
        self.assertTrue(type(rng[0]) == datetime)
        self.assertTrue(isinstance(rng.offset, offsets.BDay))
        self.assertTrue(rng.values.dtype == object)
    ...
    def test_ms_vs_MS(self):
        ...
        self.assertTrue(left == datetools.Milli())
        self.assertTrue(right == datetools.MonthBegin())

    def test_rule_aliases(self):
        rule = datetools.to_offset('10us')
        self.assertTrue(rule == datetools.Micro(10))
    ...
    def test_partial_slice(self):
        ...
        result = s['2005-1-1']
        self.assertTrue(result == s.irow(0))
    ...
    def test_partial_slice_hourly(self):
        ...
        self.assertTrue(s['2005-1-1 20:00'] == s.ix[0])
    ...
    def test_partial_slice_minutely(self):
        ...
        self.assertTrue(s['2005-1-1 23:59:00'] == s.ix[0])
    ...
    def test_date_range_normalize(self):
        ...
        self.assertTrue(np.array_equal(rng, values))

        rng = date_range(
            '1/1/2000 08:15', periods=n, normalize=False, freq='B')
        the_time = time(8, 15)
        for val in rng:
            self.assertTrue(val.time() == the_time)
    ...
    def test_setops_preserve_freq(self):
        ...
        self.assertTrue(result.freq == rng.freq)
        ...
        self.assertTrue(result.freqstr == 'D')
    ...
    def test_min_max(self):
        ...
        the_min = rng2.min()
        the_max = rng2.max()
        self.assertTrue(isinstance(the_min, Timestamp))
        self.assertTrue(isinstance(the_max, Timestamp))
...
class TestDatetime64(unittest.TestCase):
    ...
    def test_datetimeindex_accessors(self):
        ...
        self.assertEqual(dti.dayofweek[0], 5)

        self.assertEqual(dti.dayofyear[0], 31)
        self.assertEqual(dti.dayofyear[1], 120)

        self.assertEqual(dti.weekofyear[0], 5)
        self.assertEqual(dti.weekofyear[1], 18)

        self.assertEqual(dti.quarter[0], 1)
        self.assertEqual(dti.quarter[1], 2)

        self.assertEqual(len(dti.year), 100)
        self.assertEqual(len(dti.month), 100)
        self.assertEqual(len(dti.day), 100)
        self.assertEqual(len(dti.hour), 100)
        self.assertEqual(len(dti.minute), 100)
        self.assertEqual(len(dti.second), 100)
        self.assertEqual(len(dti.microsecond), 100)
        self.assertEqual(len(dti.dayofweek), 100)
        self.assertEqual(len(dti.dayofyear), 100)
        self.assertEqual(len(dti.weekofyear), 100)
        self.assertEqual(len(dti.quarter), 100)

    def test_nanosecond_field(self):
        dti = DatetimeIndex(np.arange(10))

        self.assertTrue(np.array_equal(dti.nanosecond, np.arange(10)))
    ...
    def test_datetimeindex_diff(self):
        ...
        dti2 = DatetimeIndex(freq='Q-JAN', start=datetime(1997, 12, 31),
                             periods=98)
        self.assertTrue(len(dti1.diff(dti2)) == 2)
    ...
    def test_dti_reset_index_round_trip(self):
        ...
        d2 = d1.reset_index()
        self.assertTrue(d2.dtypes[0] == np.dtype('M8[ns]'))
    ...
    def test_datetimeindex_union_join_empty(self):
        ...
        self.assertTrue(isinstance(result, DatetimeIndex))
        self.assertTrue(result is result)
...
class TestSeriesDatetime64(unittest.TestCase):
    ...
    def test_auto_conversion(self):
        ...
        self.assertTrue(series.dtype == 'M8[ns]')
    ...
    def test_set_none_nan(self):
        self.series[3] = None
        self.assertTrue(self.series[3] is NaT)

        self.series[3:5] = None
        self.assertTrue(self.series[4] is NaT)

        self.series[5] = np.nan
        self.assertTrue(self.series[5] is NaT)

        self.series[5:7] = np.nan
        self.assertTrue(self.series[6] is NaT)
    ...
    def test_union(self):
        ...
        self.assertTrue(df.index.values.dtype == np.dtype('M8[ns]'))
...
class TestTimestamp(unittest.TestCase):
    ...
    def test_basics_nanos(self):
        ...
        self.assertTrue(stamp.year == 2000)
        self.assertTrue(stamp.month == 1)
        self.assertTrue(stamp.microsecond == 0)
        self.assertTrue(stamp.nanosecond == 500)
    ...
    def test_unit(self):
        def check(val,unit=None,h=1,s=1,us=0):
            ...
            self.assertTrue(stamp.year == 2000)
            self.assertTrue(stamp.month == 1)
            self.assertTrue(stamp.day == 1)
            self.assertTrue(stamp.hour == h)
            if unit != 'D':
                self.assertTrue(stamp.minute == 1)
                self.assertTrue(stamp.second == s)
                self.assertTrue(stamp.microsecond == us)
            else:
                self.assertTrue(stamp.minute == 0)
                self.assertTrue(stamp.second == 0)
                self.assertTrue(stamp.microsecond == 0)
            self.assertTrue(stamp.nanosecond == 0)
        ...
        check(val)
        check(val/1000,unit='us')
        check(val/1000000,unit='ms')
        check(val/1000000000,unit='s')
        check(days,unit='D',h=0)

        # using truediv, so these are like floats
        if py3compat.PY3:
            check((val+500000)/1000000000,unit='s',us=500)
            check((val+500000000)/1000000000,unit='s',us=500000)
            check((val+500000)/1000000,unit='ms',us=500)

        # get chopped in py2
        else:
            check((val+500000)/1000000000,unit='s')
            check((val+500000000)/1000000000,unit='s')
            check((val+500000)/1000000,unit='ms')

        # ok
        check((val+500000)/1000,unit='us',us=500)
        check((val+500000000)/1000000,unit='ms',us=500000)
    ...
    def test_delta_preserve_nanos(self):
        ...
        self.assertTrue(result.nanosecond == val.nanosecond)
