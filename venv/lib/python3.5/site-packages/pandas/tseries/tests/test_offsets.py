...
class TestDateOffset(unittest.TestCase):
    ...
    def test_eq(self):
        ...
        self.assertTrue(not (offset1 == offset2))
...
class TestWeek(unittest.TestCase):
    ...
    def test_isAnchored(self):
        ...
        self.assertTrue(not Week().isAnchored())
        self.assertTrue(not Week(2, weekday=2).isAnchored())
        self.assertTrue(not Week(2).isAnchored())
...
class TestWeekOfMonth(unittest.TestCase):
    ...
    def test_onOffset(self):
        ...
        for week, weekday, date, expected in test_cases:
            ...
            self.assertTrue(offset.onOffset(date) == expected)
...
class TestBQuarterBegin(unittest.TestCase):
    ...
    def test_isAnchored(self):
        ...
        self.assertTrue(not BQuarterBegin(2, startingMonth=1).isAnchored())
...
class TestBQuarterEnd(unittest.TestCase):
    ...
    def test_isAnchored(self):
        ...
        self.assertTrue(not BQuarterEnd(2, startingMonth=1).isAnchored())
...
class TestQuarterBegin(unittest.TestCase):
    def test_isAnchored(self):
        ...
        self.assertTrue(not QuarterBegin(2, startingMonth=1).isAnchored())
...
class TestQuarterEnd(unittest.TestCase):
    ...
    def test_isAnchored(self):
        ...
        self.assertTrue(not QuarterEnd(2, startingMonth=1).isAnchored())
