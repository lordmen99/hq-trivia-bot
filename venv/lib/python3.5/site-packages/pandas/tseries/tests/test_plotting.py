...
class TestTSPlot(unittest.TestCase):
    ...
    def test_nonnumeric_exclude(self):
        ...
        plt.close('all')
        ax = df.plot() # it works
        self.assertTrue(len(ax.get_lines()) == 1) #B was plotted
    ...
    def test_tsplot(self):
        ...
        plt.close('all')
        ax = ts.plot(style='k')
        self.assertTrue((0., 0., 0.) == ax.get_lines()[0].get_color())
    ...
    def test_get_datevalue(self):
        ...
        self.assertTrue(get_datevalue(None, 'D') is None)
        self.assertTrue(get_datevalue(1987, 'A') == 1987)
        self.assertTrue(get_datevalue(Period(1987, 'A'), 'M') ==
                     Period('1987-12', 'M').ordinal)
        self.assertTrue(get_datevalue('1/1/1987', 'D') ==
    ...
    def test_fake_inferred_business(self):
        ...
        ts = ts[:3].append(ts[5:])
        ax = ts.plot()
        self.assertTrue(not hasattr(ax, 'freq'))
    ...
    def test_business_freq(self):
        ...
        ax = bts.plot()
        self.assertTrue(ax.get_lines()[0].get_xydata()[0, 0],
                     bts.index[0].ordinal)
        idx = ax.get_lines()[0].get_xdata()
        self.assertTrue(PeriodIndex(data=idx).freqstr == 'B')
    ...
    def test_business_freq_convert(self):
        ...
        ts = bts.to_period('M')
        ax = bts.plot()
        self.assertTrue(ax.get_lines()[0].get_xydata()[0, 0], ts.index[0].ordinal)
        idx = ax.get_lines()[0].get_xdata()
        self.assertTrue(PeriodIndex(data=idx).freqstr == 'M')
    ...
    def test_nonzero_base(self):
        ...
        self.assertTrue(not Index(rs).is_normalized)
    ...
    def test_finder_annual(self):
        ...
        for i, nyears in enumerate([5, 10, 19, 49, 99, 199, 599, 1001]):
            ...
            xaxis = ax.get_xaxis()
            rs = xaxis.get_majorticklocs()[0]
            self.assertTrue(rs == Period(xp[i], freq='A').ordinal)
            plt.close('all')
    ...
    def test_gaps(self):
        ...
        l = lines[0]
        data = l.get_xydata()
        self.assertTrue(isinstance(data, np.ma.core.MaskedArray))
        mask = data.mask
    ...
    def test_gap_upsample(self):
        ...
        lines = ax.get_lines()
        self.assertTrue(len(lines) == 1)
        self.assertTrue(len(ax.right_ax.get_lines()) == 1)
        l = lines[0]
        data = l.get_xydata()
        self.assertTrue(isinstance(data, np.ma.core.MaskedArray))
        mask = data.mask
    ...
    def test_secondary_y(self):
        ...
        self.assertTrue(ax.get_yaxis().get_ticks_position() == 'right')
        self.assertTrue(not axes[0].get_yaxis().get_visible())

        ax2 = ser2.plot()
        self.assertTrue(ax2.get_yaxis().get_ticks_position() == 'left')
    ...
    def test_secondary_kde(self):
        ...
        fig = ax.get_figure()
        axes = fig.get_axes()
        self.assertTrue(axes[1].get_yaxis().get_ticks_position() == 'right')
    ...
    def test_secondary_frame(self):
        ...
        self.assertTrue(axes[0].get_yaxis().get_ticks_position() == 'right')
        self.assertTrue(axes[1].get_yaxis().get_ticks_position() == 'default')
        self.assertTrue(axes[2].get_yaxis().get_ticks_position() == 'right')
    ...
    def test_mixed_freq_regular_first(self):
        ...
        self.assertTrue(left == pidx[0].ordinal)
        self.assertTrue(right == pidx[-1].ordinal)
        plt.close('all')
    ...
    def test_mixed_freq_hf_first(self):
        ...
        for l in ax.get_lines():
            self.assertTrue(PeriodIndex(data=l.get_xdata()).freq == 'D')
    ...
    def test_mixed_freq_alignment(self):
        ...
        self.assertTrue(ax.lines[0].get_xdata()[0] == ax.lines[1].get_xdata()[0])
    ...
    def test_mixed_freq_lf_first(self):
        ...
        for l in ax.get_lines():
            self.assertTrue(PeriodIndex(data=l.get_xdata()).freq == 'D')
        leg = ax.get_legend()
        self.assertTrue(len(leg.texts) == 2)
        ...
        ax = high.plot()
        for l in ax.get_lines():
            self.assertTrue(PeriodIndex(data=l.get_xdata()).freq == 'T')
    ...
    def test_secondary_upsample(self):
        ...
        for l in ax.get_lines():
            self.assertTrue(l.get_xdata().freq == 'D')
    ...
    def test_secondary_legend(self):
        ...
        leg = ax.get_legend()
        self.assertTrue(len(leg.get_lines()) == 4)
        self.assertTrue(leg.get_texts()[0].get_text() == 'A (right)')
        self.assertTrue(leg.get_texts()[1].get_text() == 'B (right)')
        self.assertTrue(leg.get_texts()[2].get_text() == 'C')
        self.assertTrue(leg.get_texts()[3].get_text() == 'D')
        self.assertTrue(ax.right_ax.get_legend() is None)
        colors = set()
        for line in leg.get_lines():
            colors.add(line.get_color())

        # TODO: color cycle problems
        self.assertTrue(len(colors) == 4)
        ...
        leg = ax.get_legend()
        self.assertTrue(len(leg.get_lines()) == 4)
        self.assertTrue(leg.get_texts()[0].get_text() == 'A')
        self.assertTrue(leg.get_texts()[1].get_text() == 'B')
        self.assertTrue(leg.get_texts()[2].get_text() == 'C')
        self.assertTrue(leg.get_texts()[3].get_text() == 'D')
    ...
    def test_format_date_axis(self):
        ...
        for l in xaxis.get_ticklabels():
            if len(l.get_text()) > 0:
                self.assertTrue(l.get_rotation() == 30)
