...
class TestPeriodProperties(TestCase):
    ...
    def test_period_cons_quarterly(self):
        ...
        for month in MONTHS:
            ...
            self.assertTrue('1989Q3' in str(exp))
    ...
    def test_freq_str(self):
        i1 = Period('1982', freq='Min')
        self.assertTrue(i1.freq[0] != '1')

    def test_repr(self):
        p = Period('Jan-2000')
        self.assertTrue('2000-01' in repr(p))

        p = Period('2000-12-15')
        self.assertTrue('2000-12-15' in repr(p))

    def test_strftime(self):
        p = Period('2000-1-1 12:34:12', freq='S')
        res = p.strftime('%Y-%m-%d %H:%M:%S')
        self.assertTrue( res ==  '2000-01-01 12:34:12')
        self.assertTrue( isinstance(res,str)) # GH3363
    ...
    def test_constructor_infer_freq(self):
        p = Period('2007-01-01')
        self.assertTrue(p.freq == 'D')

        p = Period('2007-01-01 07')
        self.assertTrue(p.freq == 'H')

        p = Period('2007-01-01 07:10')
        self.assertTrue(p.freq == 'T')

        p = Period('2007-01-01 07:10:15')
        self.assertTrue(p.freq == 'S')
...
class TestPeriodIndex(TestCase):
    ...
    def test_make_time_series(self):
        ...
        self.assertTrue(isinstance(series, TimeSeries))

    def test_astype(self):
        idx = period_range('1990', '2009', freq='A')

        result = idx.astype('i8')
        self.assertTrue(np.array_equal(result, idx.values))
    ...
    def test_constructor_arrays_negative_year(self):
        ...
        self.assertTrue(np.array_equal(pindex.year, years))
        self.assertTrue(np.array_equal(pindex.quarter, quarters))
    ...
    def test_getitem_ndim2(self):
        ...
        result = idx[:, None]
        # MPL kludge
        self.assertTrue(type(result) == PeriodIndex)
    ...
    def test_tolist(self):
        index = PeriodIndex(freq='A', start='1/1/2001', end='12/1/2009')
        rs = index.tolist()
        [self.assertTrue(isinstance(x, Period)) for x in rs]
    ...
    def test_frame_setitem(self):
        ...
        self.assertTrue(isinstance(rs.index, PeriodIndex))
    ...
    def test_asfreq_ts(self):
        ...
        self.assertTrue(len(result) == len(ts))
        self.assertTrue(result.index.equals(exp_index))
    ...
    def test_to_period_quarterlyish(self):
        ...
        for off in offsets:
            ...
            prng = rng.to_period()
            self.assertTrue(prng.freq == 'Q-DEC')
    ...
    def test_to_period_annualish(self):
        ...
        for off in offsets:
            rng = date_range('01-Jan-2012', periods=8, freq=off)
            prng = rng.to_period()
            self.assertTrue(prng.freq == 'A-DEC')
    ...
    def test_iteration(self):
        ...
        self.assertTrue(result[0].freq == index.freq)
    ...
    def test_take(self):
        ...
        self.assertTrue(isinstance(taken, PeriodIndex))
        self.assertTrue(taken.freq == index.freq)
        self.assertTrue(isinstance(taken2, PeriodIndex))
        self.assertTrue(taken2.freq == index.freq)
    ...
    def test_joins(self):
        ...
        for kind in ['inner', 'outer', 'left', 'right']:
            ...
            self.assertTrue(isinstance(joined, PeriodIndex))
            self.assertTrue(joined.freq == index.freq)
    ...
    def test_is_full(self):
        ...
        self.assertTrue(not index.is_full)
    ...
    def test_convert_array_of_periods(self):
        ...
        self.assertTrue(isinstance(result, PeriodIndex))
    ...
    def test_with_multi_index(self):
        ...
        self.assertTrue(isinstance(s.index.levels[0], PeriodIndex))

        self.assertTrue(isinstance(s.index.values[0][0], Period))
    ...
    def test_get_loc_msg(self):
        ...
        try:
            ...
            self.assertTrue(inst.args[0] == bad_period)
    ...
    def test_append_concat(self):
        ...
        self.assertTrue(isinstance(result.index, PeriodIndex))
...
class TestPeriodRepresentation(unittest.TestCase):
    ...
    def _check_freq(self, freq, base_date):
        ...
        self.assertTrue(np.array_equal(rng.values, exp))
