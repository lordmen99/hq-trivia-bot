...
class TestFrequencyInference(unittest.TestCase):
    ...
    def test_business_daily(self):
        ...
        self.assertTrue(infer_freq(index) == 'B')
    ...
    def test_day_corner(self):
        ...
        self.assertTrue(infer_freq(index) == 'D')

    def test_non_datetimeindex(self):
        dates = to_datetime(['1/1/2000', '1/2/2000', '1/3/2000'])
        self.assertTrue(infer_freq(dates) == 'D')
    ...
    def _check_tick(self, base_delta, code):
        ...
        for i in range(1, 5):
            ...
            if i > 1:
                ...
                exp_freq = code
            self.assertTrue(infer_freq(index) == exp_freq)

        index = _dti([b + base_delta * 7] +
                     [b + base_delta * j for j in range(3)])
        self.assertTrue(infer_freq(index) is None)
    ...
    def test_monthly_ambiguous(self):
        ...
        self.assertTrue(rng.inferred_freq == 'M')
    ...
    def test_annual_ambiguous(self):
        ...
        self.assertTrue(rng.inferred_freq == 'A-JAN')
    ...
    def _check_generated_range(self, start, freq):
        ...
        if not freq.startswith('Q-'):
            self.assertTrue(infer_freq(index) == gen.freqstr)
        else:
    ...
    def test_infer_freq(self):
        ...
        self.assertTrue(rng.inferred_freq == 'Q-DEC')

        rng = period_range('1959Q2', '2009Q3', freq='Q-NOV')
        rng = Index(rng.to_timestamp('D', how='e').asobject)
        self.assertTrue(rng.inferred_freq == 'Q-NOV')

        rng = period_range('1959Q2', '2009Q3', freq='Q-OCT')
        rng = Index(rng.to_timestamp('D', how='e').asobject)
        self.assertTrue(rng.inferred_freq == 'Q-OCT')

    def test_not_monotonic(self):
        rng = _dti(['1/31/2000', '1/31/2001', '1/31/2002'])
        rng = rng[::-1]
        self.assertTrue(rng.inferred_freq is None)
