...
class TestGenRangeGeneration(unittest.TestCase):
    def test_generate(self):
        ...
        self.assertTrue(np.array_equal(rng1, rng2))
...
class TestDateRange(unittest.TestCase):
    ...
    def test_getitem(self):
        smaller = self.rng[:5]
        self.assertTrue(np.array_equal(smaller, self.rng.view(np.ndarray)[:5]))
        ...
        self.assertTrue(isinstance(fancy_indexed, DatetimeIndex))
        self.assertTrue(fancy_indexed.freq is None)
    ...
    def test_pickle_unpickle(self):
        ...
        self.assertTrue(unpickled.offset is not None)
    ...
    def test_union(self):
        ...
        self.assertTrue(isinstance(the_union, DatetimeIndex))
        ...
        the_union = left.union(right)
        self.assertTrue(isinstance(the_union, Index))
        ...
        self.assertTrue(np.array_equal(right.union(left), the_union))
    ...
    def test_outer_join(self):
        ...
        self.assertTrue(isinstance(the_join, DatetimeIndex))
        ...
        the_join = left.join(right, how='outer')
        self.assertTrue(isinstance(the_join, DatetimeIndex))
        self.assertTrue(the_join.freq is None)
