...
class TestMerge(unittest.TestCase):
    ...
    def test_cython_left_outer_join(self):
        ...
        self.assertTrue(np.array_equal(ls, exp_ls))
        self.assertTrue(np.array_equal(rs, exp_rs))
    ...
    def test_handle_overlap(self):
        ...
        self.assertTrue('key1.foo' in joined)
        self.assertTrue('key1.bar' in joined)
    ...
    def test_handle_overlap_arbitrary_key(self):
        joined = merge(self.df, self.df2,
                       ...
                       suffixes=['.foo', '.bar'])
        self.assertTrue('key1.foo' in joined)
        self.assertTrue('key2.bar' in joined)
    ...
    def test_join_on(self):
        ...
        self.assertTrue(np.array_equal(merged['MergedA'], target['A']))
        self.assertTrue(np.array_equal(merged['MergedD'], target['D']))
    ...
    def test_join_on_inner(self):
        ...
        self.assertTrue(np.array_equal(joined['key'], expected['key']))
        self.assertTrue(np.array_equal(joined['value'], expected['value']))
    ...
    def test_join_index_mixed(self):
        df1 = DataFrame({'A': 1., 'B': 2, 'C': 'foo', 'D': True},
                        index=np.arange(10),
                        columns=['A', 'B', 'C', 'D'])
        self.assertTrue(df1['B'].dtype == np.int64)
        self.assertTrue(df1['D'].dtype == np.bool_)
    ...
    def test_join_float64_float32(self):
        ...
        joined = a.join(b)
        self.assertTrue(joined.dtypes['a'] == 'float64')
        self.assertTrue(joined.dtypes['b'] == 'float64')
        self.assertTrue(joined.dtypes['c'] == 'float32')
        ...
        self.assertTrue(rs.dtypes['a'] == 'int64')
        self.assertTrue(rs.dtypes['b'] == 'float64')
        self.assertTrue(rs.dtypes['c'] == 'float32')
        self.assertTrue(rs.dtypes['md'] == 'float32')
    ...
    def test_merge_overlap(self):
        ...
        self.assertTrue('v1_x' in merged)
        self.assertTrue('v1_y' in merged)
    ...
    def test_join_sort(self):
        ...
        self.assertTrue(np.array_equal(joined.index, list(range(4))))
    ...
    def test_handle_join_key_pass_array(self):
        ...
        self.assertTrue(np.array_equal(merged['key_0'],
        ...
        self.assertTrue(np.array_equal(merged['key_0'], key))
...
class TestConcatenate(unittest.TestCase):
    ...
    def test_append(self):
        ...
        self.assertTrue('A' in partial_appended)
        ...
        self.assertTrue(appended is not self.frame)
    ...
    def test_append_missing_column_proper_upcast(self):
        ...
        self.assertTrue(appended['A'].dtype == 'f8')
        self.assertTrue(appended['B'].dtype == 'O')
    ...
    def test_concat_keys_specific_levels(self):
        ...
        self.assertTrue(np.array_equal(result.columns.levels[0], level))
    ...
    def test_concat_keys_and_levels(self):
        ...
        self.assertTrue(np.array_equal(result.index.levels[0], ['baz', 'foo']))
    ...
    def test_concat_datetime64_block(self):
        ...
        result = concat([df, df])
        self.assertTrue((result[:10]['time'] == rng).all())
