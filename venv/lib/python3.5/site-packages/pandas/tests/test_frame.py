...
def _check_mixed_float(df, dtype = None):
    ...
    if isinstance(dtype, str):
        dtypes = dict([ (k,dtype) for k, v in list(dtypes.items()) ])
...
class CheckIndexing(object):
    ...
    def test_getitem(self):
        ...
        for key, _ in self.frame._series.items():
            self.assertTrue(self.frame[key] is not None)

        self.assertTrue('random' not in self.frame)
    ...
    def test_get(self):
        ...
        self.assertTrue(self.frame.get('foo') is None)
    ...
    def test_getitem_boolean(self):
        ...
        self.assertTrue(np.array_equal(subindex, subframe.index))
        ...
        for df in [ self.tsframe, self.mixed_frame, self.mixed_float, self.mixed_int ]:
            ...
            for c in df.columns:
                if bif[c].dtype != bifw[c].dtype:
                    self.assertTrue(bif[c].dtype == df[c].dtype)
    ...
    def test_setitem(self):
        ...
        self.assertTrue('col5' in self.frame)
        ...
        for dtype in ['int32','int64','float32','float64']:
            ...
            self.assertTrue(self.frame[dtype].dtype.name == dtype)
    ...
    def test_setitem_cast(self):
        ...
        self.assertTrue(self.frame['D'].dtype == np.int64)

        # #669, should not cast?
        # this is now set to int64, which means a replacement of the column to
        # the value dtype (and nothing to do with the existing dtype)
        self.frame['B'] = 0
        self.assertTrue(self.frame['B'].dtype == np.int64)
        ...
        self.frame['foo'] = 'bar'
        self.frame['foo'] = 0
        self.assertTrue(self.frame['foo'].dtype == np.int64)

        self.frame['foo'] = 'bar'
        self.frame['foo'] = 2.5
        self.assertTrue(self.frame['foo'].dtype == np.float64)

        self.frame['something'] = 0
        self.assertTrue(self.frame['something'].dtype == np.int64)
        self.frame['something'] = 2
        self.assertTrue(self.frame['something'].dtype == np.int64)
        self.frame['something'] = 2.5
        self.assertTrue(self.frame['something'].dtype == np.float64)
    ...
    def test_setitem_ambig(self):
        ...
        self.assertTrue(dm[2].dtype == np.object_)
    ...
    def test_setitem_clear_caches(self):
        ...
        self.assertTrue(df['z'] is not foo)
    ...
    def test_setitem_fancy_2d(self):
        ...
        lst = [100]
        lst.extend([np.nan] * 4)
        expected = DataFrame(list(zip([100, 3, 9, 6, 7], lst)), columns=['a', 'b'])
        frame[frame['a'] == 2] = 100
        assert_frame_equal(frame, expected)

    def test_fancy_getitem_slice_mixed(self):
        sliced = self.mixed_frame.ix[:, -3:]
        self.assertTrue(sliced['D'].dtype == np.float64)
    ...
    def test_getitem_setitem_float_labels(self):
        ...
        # positional slicing!
        cp.ix[1.0:5] = 0
        self.assertTrue((cp.ix[1.0:5] == 0).values.all())
        self.assertTrue((cp.ix[0:1] == df.ix[0:1]).values.all())

        cp = df.copy()
        # positional again
        cp.ix[4:5] = 0
        self.assertTrue((cp.ix[4:5] == 0).values.all())
        self.assertTrue((cp.ix[0:4] == df.ix[0:4]).values.all())

        cp = df.copy()
        # label-based
        cp.ix[1.0:5.0] = 0
        self.assertTrue((cp.ix[1.0:5.0] == 0).values.all())
    ...
    def test_getitem_list_duplicates(self):
        ...
        result = df[['B', 'C']]
        self.assertTrue(result.columns.name == 'foo')
    ...
    def test_lookup(self):
        ...
        self.assertTrue(df['mask'].dtype == np.bool_)
    ...
    def test_set_value_resize(self):
        ...
        self.assertTrue(res is not self.frame)
        self.assertTrue(res.index[-1] == 'foobar')
        self.assertEqual(res.get_value('foobar', 'B'), 0)

        res2 = res.set_value('foobar', 'qux', 0)
        self.assertTrue(res2 is not res)
        self.assertTrue(np.array_equal(res2.columns,
                                    list(self.frame.columns) + ['qux']))
        self.assertEqual(res2.get_value('foobar', 'qux'), 0)

        res3 = res.set_value('foobar', 'baz', 'sam')
        self.assertTrue(res3['baz'].dtype == np.object_)
        ...
        self.assertTrue(isnull(res3['baz'].drop(['foobar'])).values.all())
    ...
    def test_set_value_with_index_dtype_change(self):
        ...
        self.assertTrue(list(res.index) == list(df.index) + ['C'])
        self.assertTrue(list(res.columns) == list(df.columns) + [2])
...
class SafeForSparse(object):
    ...
    def test_add_prefix_suffix(self):
        ...
        self.assertTrue(np.array_equal(with_prefix.columns, expected))

        with_suffix = self.frame.add_suffix('#foo')
        expected = ['%s#foo' % c for c in self.frame.columns]
        self.assertTrue(np.array_equal(with_suffix.columns, expected))
...
class TestDataFrame(unittest.TestCase, CheckIndexing,
    ...
    def setUp(self):
        ...
        self.intframe = DataFrame(dict([ (c,s) for c,s in _intframe.items() ]), dtype = np.int64)
    ...
    def test_get_axis(self):
        f = self.frame
        self.assertTrue(f._get_axis_name(0) == 'index')
        self.assertTrue(f._get_axis_name(1) == 'columns')
        self.assertTrue(f._get_axis_name('index') == 'index')
        self.assertTrue(f._get_axis_name('columns') == 'columns')
        self.assertRaises(Exception, f._get_axis_name, 'foo')
        self.assertRaises(Exception, f._get_axis_name, None)

        self.assertTrue(f._get_axis_number(0) == 0)
        self.assertTrue(f._get_axis_number(1) == 1)
        self.assertTrue(f._get_axis_number('index') == 0)
        self.assertTrue(f._get_axis_number('columns') == 1)
        self.assertRaises(Exception, f._get_axis_number, 2)
        self.assertRaises(Exception, f._get_axis_number, None)

        self.assertTrue(self.frame._get_axis(0) is self.frame.index)
        self.assertTrue(self.frame._get_axis(1) is self.frame.columns)
    ...
    def test_set_index(self):
        ...
        self.assertTrue(self.mixed_frame['foo'].index is idx)
    ...
    def test_set_index_cast_datetimeindex(self):
        ...
        idf = df.set_index('A')
        self.assertTrue(isinstance(idf.index, DatetimeIndex))
    ...
    def test_keys(self):
        ...
        self.assertTrue(getkeys() is self.frame.columns)
    ...
    def test_constructor_cast_failure(self):
        ...
        self.assertTrue(foo['a'].dtype == object)
    ...
    def test_constructor_dtype_list_data(self):
        df = DataFrame([[1, '2'],
                        [None, 'a']], dtype=object)
        self.assertTrue(df.ix[1, 0] is None)
        self.assertTrue(df.ix[0, 1] == '2')

    def test_constructor_list_frames(self):

        # GH 3243
        result = DataFrame([DataFrame([])])
        self.assertTrue(result.shape == (1,0))

        result = DataFrame([DataFrame(dict(A = list(range(5))))])
        self.assertTrue(type(result.iloc[0,0]) == DataFrame)
    ...
    def test_constructor_rec(self):
        ...
        df = DataFrame(rec)
        self.assertTrue(np.array_equal(df.columns, rec.dtype.names))

        df2 = DataFrame(rec, index=index)
        self.assertTrue(np.array_equal(df2.columns, rec.dtype.names))
    ...
    def test_constructor_overflow_int64(self):
        ...
        self.assertTrue(result['a'].dtype == object)
        ...
        self.assertTrue(df_crawls['uid'].dtype == object)

    def test_is_mixed_type(self):
        self.assertTrue(not self.frame._is_mixed_type)
    ...
    def test_constructor_ordereddict(self):
        ...
        df = DataFrame(OrderedDict(list(zip(expected, [[0]] * nitems))))
    ...
    def test_constructor_dict(self):
        ...
        self.assertTrue('col1' not in frame)
        ...
        self.assertTrue(np.array_equal(frame.index, ['1', '2']))

        # empty dict plus index
        idx = Index([0, 1, 2])
        frame = DataFrame({}, index=idx)
        self.assertTrue(frame.index is idx)

        # empty with index and columns
        idx = Index([0, 1, 2])
        frame = DataFrame({}, index=idx, columns=idx)
        self.assertTrue(frame.index is idx)
        self.assertTrue(frame.columns is idx)
    ...
    def test_constructor_subclass_dict(self):
        ...
        df = DataFrame(data)
        refdf = DataFrame(dict((col, dict(iter(val.items())))
                               for col, val in data.items()))
        assert_frame_equal(refdf, df)

        data = tm.TestSubDict(iter(data.items()))
        df = DataFrame(data)
        assert_frame_equal(refdf, df)
    ...
    def test_constructor_dict_cast(self):
        ...
        self.assertTrue(frame['B'].dtype == np.float64)
        self.assertTrue(frame['A'].dtype == np.float64)

        frame = DataFrame(test_data)
        self.assertEqual(len(frame), 3)
        self.assertTrue(frame['B'].dtype == np.object_)
        self.assertTrue(frame['A'].dtype == np.float64)

        # can't cast to float
        test_data = {
            'A': dict(list(zip(list(range(20)), tm.makeStringIndex(20)))),
            'B': dict(list(zip(list(range(15)), randn(15))))
        }
        frame = DataFrame(test_data, dtype=float)
        self.assertEqual(len(frame), 20)
        self.assertTrue(frame['A'].dtype == np.object_)
        self.assertTrue(frame['B'].dtype == np.float64)

    def test_constructor_dict_dont_upcast(self):
        d = {'Col1': {'Row1': 'A String', 'Row2': np.nan}}
        df = DataFrame(d)
        self.assertTrue(isinstance(df['Col1']['Row2'], float))

        dm = DataFrame([[1, 2], ['a', 'b']], index=[1, 2], columns=[1, 2])
        self.assertTrue(isinstance(dm[1][1], int))
    ...
    def test_constructor_dict_of_tuples(self):
        ...
        expected = DataFrame(dict((k, list(v)) for k, v in data.items()))
    ...
    def test_constructor_ndarray(self):
        ...
        self.assertTrue(frame.values.dtype == np.int64)
        ...
        # automatic labeling
        frame = DataFrame(mat)
        self.assertTrue(np.array_equal(frame.index, list(range(2))))
        self.assertTrue(np.array_equal(frame.columns, list(range(3))))
        ...
        self.assertTrue(len(frame.index) == 0)

        frame = DataFrame(np.empty((3, 0)))
        self.assertTrue(len(frame.columns) == 0)
    ...
    def test_constructor_maskedarray_nonfloat(self):
        ...
        self.assertTrue(frame.values.dtype == np.float64)
        ...
        self.assertTrue(frame.values.dtype == object)
    ...
    def test_constructor_corner(self):
        ...
        self.assertTrue(df.values.dtype == np.object_)
    ...
    def test_constructor_scalar_inference(self):
        ...
        self.assertTrue(df['int'].dtype == np.int64)
        self.assertTrue(df['bool'].dtype == np.bool_)
        self.assertTrue(df['float'].dtype == np.float64)
        self.assertTrue(df['complex'].dtype == np.complex128)
        self.assertTrue(df['object'].dtype == np.object_)
    ...
    def test_constructor_DataFrame(self):
        ...
        self.assertTrue(df_casted.values.dtype == np.int64)
    ...
    def test_constructor_more(self):
        ...
        self.assertEqual(len(dm.columns), 2)
        self.assertTrue(dm.values.dtype == np.float64)
    ...
    def test_constructor_list_of_lists(self):
        ...
        self.assertTrue(df['str'].dtype == np.object_)
    ...
    def test_constructor_list_of_dicts(self):
        ...
        result = DataFrame(data)
        expected = DataFrame.from_dict(dict(list(zip(list(range(len(data))), data))),
                                       orient='index')
    ...
    def test_constructor_list_of_series(self):
        ...
        sdict = OrderedDict(list(zip(['x', 'y'], data)))
        idx = Index(['a', 'b', 'c'])
        ...
        sdict = OrderedDict(list(zip(['x', 'Unnamed 0'], data)))
        expected = DataFrame.from_dict(sdict, orient='index')
        ...
        result = DataFrame(data)
        sdict = OrderedDict(list(zip(list(range(len(data))), data)))
        expected = DataFrame.from_dict(sdict, orient='index')
        assert_frame_equal(result, expected.reindex(result.index))
    ...
    def test_constructor_Series_named(self):
        ...
        df = DataFrame(a)
        self.assertTrue(df.columns[0] == 'x')
    ...
    def test_constructor_Series_differently_indexed(self):
        ...
        self.assertTrue(df1.columns[0] == 'x')
        assert_frame_equal(df1, exp1)

        df2 = DataFrame(s2, index=other_index)
        exp2 = DataFrame(s2.reindex(other_index))
        self.assertTrue(df2.columns[0] == 0)
    ...
    def test_constructor_manager_resize(self):
        ...
        result = DataFrame(self.frame._data, index=index,
                           columns=columns)
        self.assertTrue(np.array_equal(result.index, index))
        self.assertTrue(np.array_equal(result.columns, columns))
    ...
    def test_constructor_from_items(self):
        ...
        self.assertTrue(recons['A'].dtype == np.float64)
        ...
        recons = DataFrame.from_items(row_items,
                                      ...
                                      orient='index')
        assert_frame_equal(recons, self.mixed_frame)
        self.assertTrue(isinstance(recons['foo'][0], tuple))
    ...
    def test_constructor_with_datetimes(self):
        ...
        self.assertTrue(datetime_s.dtype == 'M8[ns]')
    ...
    def test_operators_timedelta64(self):
        ...
        # min
        result = diffs.min()
        self.assertTrue(result[0] == diffs.ix[0,'A'])
        self.assertTrue(result[1] == diffs.ix[0,'B'])
        ...
        # max
        result = diffs.max()
        self.assertTrue(result[0] == diffs.ix[2,'A'])
        self.assertTrue(result[1] == diffs.ix[2,'B'])
    ...
    def test_new_empty_index(self):
        ...
        df1.index.name = 'foo'
        self.assertTrue(df2.index.name is None)
    ...
    def test_astype(self):
        ...
        def _check_cast(df, v):
            self.assertTrue(list(set([ s.dtype.name for _, s in df.items() ]))[0] == v)
    ...
    def test_array_interface(self):
        ...
        self.assertTrue(type(result) is type(self.frame))
        self.assertTrue(result.index is self.frame.index)
        self.assertTrue(result.columns is self.frame.columns)
    ...
    def test_to_records_dt64(self):
        ...
        self.assertTrue(df.to_records()['index'][0] == df.index[0])

        rs = df.to_records(convert_datetime64=False)
        self.assertTrue(rs['index'][0] == df.index.values[0])
    ...
    def test_from_records_to_records(self):
        ...
        self.assertTrue(np.array_equal(indexed_frame.index, index))
        ...
        self.assertTrue('index' not in records.dtype.names)
    ...
    def test_from_records_decimal(self):
        ...
        self.assertTrue(df['a'].dtype == object)

        df = DataFrame.from_records(tuples, columns=['a'], coerce_float=True)
        self.assertTrue(df['a'].dtype == np.float64)
    ...
    def test_from_records_set_index_name(self):
        ...
        self.assertTrue(result.index.name == 'order_id')

        # MultiIndex
        result = DataFrame.from_records(documents,
                                        index=['order_id', 'quantity'])
        self.assertTrue(result.index.names == ['order_id', 'quantity'])
    ...
    def test_to_recods_index_name(self):
        ...
        df.index.name = 'X'
        rs = df.to_records()
        self.assertTrue('X' in rs.dtype.fields)

        df = DataFrame(np.random.randn(3, 3))
        rs = df.to_records()
        self.assertTrue('index' in rs.dtype.fields)

        df.index = MultiIndex.from_tuples([('a', 'x'), ('a', 'y'), ('b', 'z')])
        df.index.names = ['A', None]
        rs = df.to_records()
        self.assertTrue('level_0' in rs.dtype.fields)
    ...
    def test_join_str_datetime(self):
        ...
        self.assertTrue(len(tst.columns) == 3)
    ...
    def test_from_records_sequencelike(self):
        ...
        self.assertTrue(np.array_equal(result.columns, list(range(8))))
        ...
        self.assertTrue(np.array_equal(result.columns, ['foo', 'bar', 'baz']))
    ...
    def test_from_records_dictlike(self):
        ...
        columns = []
        for dtype, b in df.blocks.items():
            columns.extend(b.columns)

        asdict    = dict((x, y) for x, y in df.items())
        asdict2   = dict((x, y.values) for x, y in df.items())
    ...
    def test_get_agg_axis(self):
        ...
        self.assertTrue(cols is self.frame.columns)

        idx = self.frame._get_agg_axis(1)
        self.assertTrue(idx is self.frame.index)
    ...
    def test_repr_column_name_unicode_truncation_bug(self):
        ...
        result = repr(df)
        self.assertTrue('StringCol' in result)
    ...
    def test_insert(self):
        ...
        self.assertTrue(np.array_equal(df.columns, ['foo', 'c', 'b', 'a']))
        assert_almost_equal(df['a'], df['foo'])

        df.insert(2, 'bar', df['c'])
        self.assertTrue(np.array_equal(df.columns, ['foo', 'c', 'bar', 'b', 'a']))
        ...
        self.assertTrue((df.get_dtype_counts() == result).all() == True)
    ...
    def test_delitem(self):
        del self.frame['A']
        self.assertTrue('A' not in self.frame)
    ...
    def test_pop(self):
        ...
        self.assertTrue('foo' not in self.frame)
    ...
    def test_itertuples(self):
        ...
        for tup in df.itertuples(index=False):
            self.assertTrue(isinstance(tup[1], np.integer))
    ...
    def test_logical_operators(self):
        ...
        def _check_bin_op(op):
            ...
            expected = DataFrame(op(df1.values, df2.values), index=df1.index,
                                 columns=df1.columns)
            self.assertTrue(result.values.dtype == np.bool_)
            assert_frame_equal(result, expected)
    ...
    def test_constructor_lists_to_object_dtype(self):
        ...
        self.assertTrue(d['a'].dtype == np.object_)
        self.assertTrue(d['a'][1] is False)
    ...
    def test_first_last_valid(self):
        ...
        self.assertTrue(index == frame.index[5])

        index = frame.last_valid_index()
        self.assertTrue(index == frame.index[-6])
    ...
    def test_bool_flex_frame(self):
        ...
        self.assertTrue(not df.ne(df).values.any())
        ...
        rs = df.gt(df2)
        self.assertTrue(not rs.values.any())
        rs = df.ne(df2)
    ...
    def test_combineSeries(self):
        ...
        for key, s in self.frame.items():
            assert_series_equal(larger_added[key], s + series[key])
        self.assertTrue('E' in larger_added)
        ...
        try:
            ...
            for key, col in self.tsframe.items():
    ...
    def test_combineFunc(self):
        result = self.frame * 2
        self.assertTrue(np.array_equal(result.values, self.frame.values * 2))

        # vs mix
        result = self.mixed_float * 2
        for c, s in result.items():
            self.assertTrue(np.array_equal(s.values, self.mixed_float[c].values * 2))
        _check_mixed_float(result, dtype = dict(C = None))

        result = self.empty * 2
        self.assertTrue(result.index is self.empty.index)
        self.assertEqual(len(result.columns), 0)
    ...
    def test_comparisons(self):
        ...
        def test_comp(func):
            result = func(df1, df2)
            self.assertTrue(np.array_equal(result.values,
                                        func(df1.values, df2.values)))

            result2 = func(self.simple, row)
            self.assertTrue(np.array_equal(result2.values,
                                        func(self.simple.values, row.values)))

            result3 = func(self.frame, 0)
            self.assertTrue(np.array_equal(result3.values,
        ...
        def _do_test(df,path,r_dtype=None,c_dtype=None,rnlvl=None,cnlvl=None,
               ...
               if r_dtype:
                    ...
                    if r_dtype == 'dt': # unicode
                        ...
                        r_dtype='O'
                        recons.index = np.array(list(map(Timestamp,recons.index.to_datetime())),
                                                dtype=r_dtype )
    ...
    def test_to_csv_float32_nanrep(self):
        ...
        with ensure_clean('__tmp_to_csv_float32_nanrep__.csv') as path:
            ...
            with open(path) as f:
                 lines = f.readlines()
                 self.assertTrue(lines[1].split(',')[2] == '999')
    ...
    def test_info_wide(self):
        ...
        df.info(buf=io)
        rs = io.getvalue()
        self.assertTrue(len(rs.splitlines()) == 4)
    ...
    def test_convert_objects(self):
        ...
        self.assertTrue(converted['A'].dtype == np.float64)
        ...
        self.assertTrue(converted['H'].dtype == 'float64')
        self.assertTrue(converted['I'].dtype == 'int64')
        self.assertTrue(converted['J'].dtype == 'float64')
        self.assertTrue(converted['K'].dtype == 'float64')
        self.assertTrue(len(converted['J'].dropna()) == l-5)
        self.assertTrue(len(converted['K'].dropna()) == l-5)
    ...
    def test_asfreq(self):
        ...
        self.assertTrue(result is not zero_length)

    def test_asfreq_datetimeindex(self):
        df = DataFrame({'A': [1, 2, 3]},
                       index=[datetime(2011, 11, 0o1), datetime(2011, 11, 2),
                              datetime(2011, 11, 3)])
        df = df.asfreq('B')
        self.assertTrue(isinstance(df.index, DatetimeIndex))

        ts = df['A'].asfreq('B')
        self.assertTrue(isinstance(ts.index, DatetimeIndex))
    ...
    def test_as_blocks(self):
        ...
        mat = frame.blocks
        self.assertTrue(set([ x.name for x in frame.dtypes.values ]) == set(mat.keys()))
    ...
    def test_copy(self):
        cop = self.frame.copy()
        cop['E'] = cop['A']
        self.assertTrue('E' not in self.frame)

        # copy objects
        copy = self.mixed_frame.copy()
        self.assertTrue(copy._data is not self.mixed_frame._data)
    ...
    def test_corr_nooverlap(self):
        ...
        for meth in ['pearson', 'kendall', 'spearman']:
            ...
            self.assertTrue(rs.ix['A', 'A'] == 1)
            self.assertTrue(rs.ix['B', 'B'] == 1)
    ...
    def test_corrwith(self):
        ...
        self.assertTrue('B' not in dropped)

        dropped = a.corrwith(b, axis=1, drop=True)
        self.assertTrue(a.index[-1] not in dropped.index)
    ...
    def test_drop_names(self):
        ...
        self.assertTrue(df_dropped_b.index.name == 'first')
        self.assertTrue(df_dropped_e.index.name == 'first')
        self.assertTrue(df_dropped_b.columns.name == 'second')
        self.assertTrue(df_dropped_e.columns.name == 'second')
    ...
    def test_dropEmptyRows(self):
        ...
        self.assertTrue(np.array_equal(smaller_frame['foo'], mat[5:]))
    ...
    def test_fillna_inplace(self):
        ...
        self.assertTrue(expected is not df)
    ...
    def test_fillna_invalid_method(self):
        try:
            ...
            self.assertTrue('ffil' in str(inst))
    ...
    def test_truncate_copy(self):
        ...
        truncated.values[:] = 5.
        self.assertTrue(not (self.tsframe.values[5:11] == 5).any())
    ...
    def test_xs(self):
        ...
        frame = DataFrame(test_data)
        xs = frame.xs('1')
        self.assertTrue(xs.dtype == np.object_)
    ...
    def test_pivot_integer_bug(self):
        ...
        repr(result)
        self.assertTrue(np.array_equal(result.columns, ['A', 'B']))
    ...
    def test_reindex(self):
        ...
        self.assertTrue(len(emptyFrame.index) == 0)
        ...
        self.assertTrue(newFrame.index is self.frame.index)
    ...
    def test_reindex_name_remains(self):
        ...
        df = df.reindex(i)
        self.assertTrue(df.index.name == 'iname')

        df = df.reindex(Index(np.arange(10), name='tmpname'))
        self.assertTrue(df.index.name == 'tmpname')

        s = Series(random.rand(10))
        df = DataFrame(s.T, index=np.arange(len(s)))
        i = Series(np.arange(10), name='iname')
        df = df.reindex(columns=i)
        self.assertTrue(df.columns.name == 'iname')

    def test_reindex_int(self):
        smaller = self.intframe.reindex(self.intframe.index[::2])

        self.assertTrue(smaller['A'].dtype == np.int64)

        bigger = smaller.reindex(self.intframe.index)
        self.assertTrue(bigger['A'].dtype == np.float64)
    ...
    def test_reindex_columns(self):
        ...
        self.assertTrue('C' not in newFrame)
    ...
    def test_align(self):
        ...
        self.assertTrue(af._data is not self.frame._data)

        af, bf = self.frame.align(self.frame, copy=False)
        self.assertTrue(af._data is self.frame._data)
    ...
    def test_transpose(self):
        ...
        for col, s in mixed_T.items():
            self.assertTrue(s.dtype == np.object_)
    ...
    def test_rename(self):
        ...
        self.assertTrue(np.array_equal(renamed.index, ['foo', 'bar']))

        renamed = df.rename(index=str.upper)
        self.assertTrue(np.array_equal(renamed.index, ['BAR', 'FOO']))
        ...
        self.assertTrue(np.array_equal(renamed.columns, ['A', 'B', 'foo', 'bar']))

        # other axis
        renamed = self.frame.T.rename(index={'C': 'foo', 'D': 'bar'})
        self.assertTrue(np.array_equal(renamed.index, ['A', 'B', 'foo', 'bar']))
        ...
        self.assertTrue(np.array_equal(renamed.index, new_index))
        self.assertTrue(np.array_equal(renamed.columns, new_columns))
    ...
    def test_rename_inplace(self):
        ...
        self.assertTrue('C' in self.frame)
        self.assertTrue('foo' not in self.frame)
        ...
        self.assertTrue('C' not in frame)
        self.assertTrue('foo' in frame)
        self.assertTrue(id(frame['foo']) != c_id)
    ...
    def test_shift(self):
        ...
        self.assertTrue(len(shiftedFrame) == len(self.tsframe))
    ...
    def test_apply(self):
        ...
        self.assertTrue(applied.index is self.frame.index)  # want this
    ...
    def test_apply_broadcast(self):
        ...
        for col, ts in broadcasted.items():
        ...
        def _check(df, f):
            ...
            def _checkit(axis=0, raw=False):
                ...
                if is_reduction:
                    ...
                    self.assertTrue(isinstance(res, Series))
                    self.assertTrue(res.index is agg_axis)
                else:
    ...
    def test_apply_multi_index(self):
        ...
        self.assertTrue(isinstance(res.index, MultiIndex))
    ...
    def test_applymap(self):
        ...
        self.assertTrue(isinstance(result['A'][0], tuple))

        # GH 2909, object conversion to float in constructor?
        df = DataFrame(data=[1,'a'])
        result = df.applymap(lambda x: x)
        self.assertTrue(result.dtypes[0] == object)
    ...
    def test_filter(self):
        ...
        self.assertTrue('E' not in filtered)
        ...
        self.assertEqual(len(filtered.columns), 2)
        self.assertTrue('AA' in filtered)
    ...
    def test_clip(self):
        ...
        self.assertTrue(not (capped.values > median).any())

        floored = self.frame.clip_lower(median)
        self.assertTrue(not (floored.values < median).any())

        double = self.frame.clip(upper=median, lower=median)
        self.assertTrue(not (double.values != median).any())
    ...
    def test_get_X_columns(self):
        ...
        self.assertTrue(np.array_equal(df._get_numeric_data().columns,
                                    ['a', 'b', 'e']))
    ...
    def test_bool_describe_in_mixed_frame(self):
        ...
        self.assertTrue(np.array_equal(df.describe().columns, ['bool_data', 'int_data']))

        bool_describe = df.describe()['bool_data']

        # Both the min and the max values should stay booleans
        self.assertTrue(bool_describe['min'].dtype == np.bool_)
        self.assertTrue(bool_describe['max'].dtype == np.bool_)

        self.assertTrue(bool_describe['min'] == False)
        self.assertTrue(bool_describe['max'] == True)
    ...
    def test_count(self):
        ...
        frame = DataFrame()
        ct1 = frame.count(1)
        self.assertTrue(isinstance(ct1, Series))

        ct2 = frame.count(0)
        self.assertTrue(isinstance(ct2, Series))
    ...
    def _check_stat_op(self, name, alternative, frame=None, has_skipna=True,
        ...
        if not ('max' in name or 'min' in name or 'count' in name):
            ...
            self.assertTrue(len(getattr(df, name)()))
        ...
        if check_dtypes:
            ...
            self.assertTrue(lcd_dtype == result0.dtype)
            self.assertTrue(lcd_dtype == result1.dtype)
    ...
    def test_sum_corner(self):
        ...
        self.assertTrue(isinstance(axis0, Series))
        self.assertTrue(isinstance(axis1, Series))
    ...
    def test_get_axis_etc(self):
        ...
        self.assertTrue(f._get_axis(0) is f.index)
        self.assertTrue(f._get_axis(1) is f.columns)
        self.assertRaises(Exception, f._get_axis_number, 2)
    ...
    def test_reindex_boolean(self):
        ...
        self.assertTrue(reindexed.values.dtype == np.object_)
    ...
    def test_reindex_objects(self):
        ...
        self.assertTrue('foo' in reindexed)

        reindexed = self.mixed_frame.reindex(columns=['A', 'B'])
        self.assertTrue('foo' not in reindexed)
    ...
    def test_reindex_corner(self):
        ...
        self.assertTrue(smaller['E'].dtype == np.float64)
    ...
    def test_rename_objects(self):
        ...
        self.assertTrue('FOO' in renamed)
        self.assertTrue('foo' not in renamed)
    ...
    def test_reset_index(self):
        ...
        self.assertTrue(np.array_equal(deleveled['first'],
                                    deleveled2['level_0']))
        self.assertTrue(np.array_equal(deleveled['second'],
                                    deleveled2['level_1']))

        # default name assigned
        rdf = self.frame.reset_index()
        self.assertTrue(np.array_equal(rdf['index'], self.frame.index.values))

        # default name assigned, corner case
        df = self.frame.copy()
        df['index'] = 'foo'
        rdf = df.reset_index()
        self.assertTrue(np.array_equal(rdf['level_0'], self.frame.index.values))

        # but this is ok
        self.frame.index.name = 'index'
        deleveled = self.frame.reset_index()
        self.assertTrue(np.array_equal(deleveled['index'],
    ...
    def test_reset_index_right_dtype(self):
        ...
        self.assertTrue(resetted['time'].dtype == np.float64)
    ...
    def test_as_matrix_numeric_cols(self):
        ...
        self.assertTrue(values.dtype == np.float64)
    ...
    def test_as_matrix_lcd(self):
        ...
        self.assertTrue(values.dtype == np.float32)

        values = self.mixed_float.as_matrix(['C'])
        self.assertTrue(values.dtype == np.float16)

        values = self.mixed_int.as_matrix(['A','B','C','D'])
        self.assertTrue(values.dtype == np.int64)
        ...
        self.assertTrue(values.dtype == np.int32)
        ...
        self.assertTrue(values.dtype == np.uint8)
    ...
    def test_constructor_frame_copy(self):
        ...
        self.assertTrue(not (self.frame['A'] == 5).all())
    ...
    def test_constructor_ndarray_copy(self):
        ...
        self.assertTrue(not (df.values[6] == 6).all())
    ...
    def test_constructor_series_copy(self):
        ...
        self.assertTrue(not (series['A'] == 5).all())
    ...
    def test_columns_with_dups(self):
        ...
        self.assertTrue(len(result) == len(df.columns))
    ...
    def test_consolidate(self):
        ...
        self.assertTrue(len(consolidated._data.blocks) == 1)

        # Ensure copy, do I want this?
        recons = consolidated.consolidate()
        self.assertTrue(recons is not consolidated)
        assert_frame_equal(recons, consolidated)

        self.frame['F'] = 8.
        self.assertTrue(len(self.frame._data.blocks) == 3)
        self.frame.consolidate(inplace=True)
        self.assertTrue(len(self.frame._data.blocks) == 1)
    ...
    def test_as_matrix_consolidate(self):
        self.frame['E'] = 7.
        self.assertTrue(not self.frame._data.is_consolidated())
    ...
    def test_xs_view(self):
        ...
        self.assertTrue((dm.xs(3) == 10).all())
    ...
    def test_boolean_indexing_mixed(self):
        df = DataFrame(
            {0: {35: np.nan, 40: np.nan, 43: np.nan, 49: np.nan, 50: np.nan},
             ...
             2: {35: np.nan, 40: np.nan, 43: 0.29012581014105987, 49: np.nan, 50: np.nan},
             3: {35: np.nan, 40: np.nan, 43: np.nan, 49: np.nan, 50: np.nan},
             4: {35: 0.34215328467153283, 40: np.nan, 43: np.nan, 49: np.nan, 50: np.nan},
    ...
    def test_sum_bools(self):
        ...
        bools = isnull(df)
        self.assertTrue(bools.sum(axis=1)[0] == 10)
    ...
    def test_fillna_col_reordering(self):
        ...
        self.assertTrue(df.columns.tolist() == filled.columns.tolist())
...
"""
    ...
    def _check_bool_op(self, name, alternative, frame=None, has_skipna=True,
        ...
        if has_skipna:
            ...
            r1 = getattr(all_na, name)(axis=1)
            if name == 'any':
                self.assertTrue(not r0.any())
                self.assertTrue(not r1.any())
            else:
