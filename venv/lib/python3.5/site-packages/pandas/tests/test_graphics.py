...
class TestSeriesPlots(unittest.TestCase):
    ...
    def test_plot(self):
        ...
        self.assertTrue(ax.title.get_text() == 'Test')
        self.assertTrue((np.round(ax.figure.get_size_inches())
                      == np.array((16., 8.))).all())
    ...
    def test_bar_linewidth(self):
        ...
        for r in ax.patches:
            self.assertTrue(r.get_linewidth() == 2)
    ...
    def test_irregular_datetime(self):
        ...
        self.assertTrue(xp == ax.get_xlim()[0])
...
class TestDataFramePlots(unittest.TestCase):
    ...
    def test_label(self):
        ...
        ax = df.plot(x='a', y='b')
        self.assertTrue(ax.xaxis.get_label().get_text() == 'a')

        plt.close('all')
        ax = df.plot(x='a', y='b', label='LABEL')
        self.assertTrue(ax.xaxis.get_label().get_text() == 'LABEL')
    ...
    def test_xcompat(self):
        ...
        lines = ax.get_lines()
        self.assertTrue(not isinstance(lines[0].get_xdata(), PeriodIndex))
        ...
        ax = df.plot()
        lines = ax.get_lines()
        self.assertTrue(isinstance(lines[0].get_xdata(), PeriodIndex))
    ...
    def test_unsorted_index(self):
        df = DataFrame({'y': list(range(100))},
                       index=list(range(99, -1, -1)))
        ax = df.plot()
        l = ax.get_lines()[0]
        rs = l.get_xydata()
    ...
    def test_subplots(self):
        ...
        for ax in axes[:-2]:
            [self.assertTrue(not label.get_visible())
    ...
    def test_hist(self):
        ...
        self.assertTrue(not axes[1, 1].get_visible())
    ...
    def test_hist_layout(self):
        ...
        for layout_test in layout_to_expected_size:
            ...
            self.assertTrue(len(ax) == layout_test['expected_size'][0])
            self.assertTrue(len(ax[0]) == layout_test['expected_size'][1])
    ...
    def test_legend_name(self):
        ...
        self.assertTrue(leg_title.get_text(), 'group,individual')
    ...
    def test_line_colors(self):
        ...
        try:
            ...
            for l1, l2 in zip(lines, lines2):
                self.assertTrue(l1.get_color(), l2.get_color())
        finally:
            sys.stderr = tmp
    ...
    def test_unordered_ts(self):
        ...
        self.assertTrue(np.all(ydata == np.array([1.0, 2.0, 3.0])))
