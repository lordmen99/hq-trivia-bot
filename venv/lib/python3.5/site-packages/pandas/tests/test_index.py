...
class TestIndex(unittest.TestCase):
    ...
    def test_new_axis(self):
        ...
        self.assertTrue(new_index.ndim == 2)
        self.assertTrue(type(new_index) == np.ndarray)

    def test_deepcopy(self):
        from copy import deepcopy

        copy = deepcopy(self.strIndex)
        self.assertTrue(copy is self.strIndex)

    def test_duplicates(self):
        idx = Index([0, 0, 0])
        self.assertTrue(not idx.is_unique)
    ...
    def test_constructor(self):
        ...
        self.assertTrue(np.array_equal(self.strIndex, index))

        # copy
        arr = np.array(self.strIndex)
        index = Index(arr, copy=True, name='name')
        self.assertTrue(isinstance(index, Index))
        self.assertTrue(index.name == 'name')
    ...
    def test_index_ctor_infer_periodindex(self):
        ...
        self.assertTrue(isinstance(rs, PeriodIndex))

    def test_copy(self):
        i = Index([], name='Foo')
        i_copy = i.copy()
        self.assertTrue(i_copy.name == 'Foo')

    def test_view(self):
        i = Index([], name='Foo')
        i_view = i.view()
        self.assertTrue(i_view.name == 'Foo')
    ...
    def test_asof(self):
        d = self.dateIndex[0]
        self.assertTrue(self.dateIndex.asof(d) is d)
        self.assertTrue(np.isnan(self.dateIndex.asof(d - timedelta(1))))

        d = self.dateIndex[-1]
        self.assertTrue(self.dateIndex.asof(d + timedelta(1)) == d)

        d = self.dateIndex[0].to_datetime()
        self.assertTrue(isinstance(self.dateIndex.asof(d), Timestamp))
    ...
    def test_comparators(self):
        ...
        def _check(op):
            ...
            self.assertTrue(isinstance(index_result, np.ndarray))
            self.assertTrue(not isinstance(index_result, Index))
            self.assertTrue(np.array_equal(arr_result, index_result))
    ...
    def test_shift(self):
        ...
        self.assertTrue(shifted is self.dateIndex)

        shifted = self.dateIndex.shift(5, timedelta(1))
        self.assertTrue(np.array_equal(shifted, self.dateIndex + timedelta(5)))

        shifted = self.dateIndex.shift(1, 'B')
        self.assertTrue(np.array_equal(shifted, self.dateIndex + offsets.BDay()))
    ...
    def test_intersection(self):
        ...
        self.assertTrue(inter is first)
    ...
    def test_union(self):
        ...
        self.assertTrue(union is first)
        ...
        second.name = 'A'
        union = first.union(second)
        self.assertTrue(union.name == 'A')

        second.name = 'B'
        union = first.union(second)
        self.assertTrue(union.name is None)
    ...
    def test_add_string(self):
        ...
        self.assertTrue('a' not in index2)
        self.assertTrue('afoo' in index2)
    ...
    def test_pickle(self):
        def testit(index):
            ...
            self.assertTrue(isinstance(unpickled, Index))
            self.assertTrue(np.array_equal(unpickled, index))
    ...
    def test_is_numeric(self):
        self.assertTrue(not self.dateIndex.is_numeric())
        self.assertTrue(not self.strIndex.is_numeric())
    ...
    def test_is_all_dates(self):
        ...
        self.assertTrue(not self.strIndex.is_all_dates)
        self.assertTrue(not self.intIndex.is_all_dates)
    ...
    def test_format(self):
        ...
        formatted = index.format()
        expected = [str(index[0]), str(index[1]), 'NaN']
        self.assertEqual(formatted, expected)
    ...
    def test_format_with_name_time_info(self):
        ...
        self.assertTrue(formatted[0] == 'something')
    ...
    def test_boolean_cmp(self):
        ...
        self.assertTrue(res.dtype == 'bool')
        self.assertTrue(not isinstance(res, Index))
...
class TestInt64Index(unittest.TestCase):
    ...
    def test_constructor(self):
        ...
        self.assertTrue(np.array_equal(index, expected))
    ...
    def test_constructor_corner(self):
        ...
        self.assertTrue(index.values.dtype == np.int64)
    ...
    def test_coerce_list(self):
        # coerce things
        arr = Index([1, 2, 3, 4])
        self.assertTrue(type(arr) == Int64Index)

        # but not if explicit dtype passed
        arr = Index([1, 2, 3, 4], dtype=object)
        self.assertTrue(type(arr) == Index)

    def test_dtype(self):
        self.assertTrue(self.index.dtype == np.int64)
    ...
    def test_get_indexer(self):
        ...
        self.assertTrue(np.array_equal(indexer, expected))
    ...
    def test_join_outer(self):
        ...
        self.assertTrue(isinstance(res, Int64Index))
        self.assertTrue(res.equals(eres))
        self.assertTrue(np.array_equal(lidx, elidx))
        self.assertTrue(np.array_equal(ridx, eridx))
    ...
    def test_join_right(self):
        ...
        self.assertTrue(isinstance(other, Int64Index))
        self.assertTrue(res.equals(eres))
        self.assertTrue(np.array_equal(lidx, elidx))
        self.assertTrue(ridx is None)
    ...
    def test_join_non_unique(self):
        ...
        self.assertTrue(np.array_equal(lidx, exp_lidx))

        exp_ridx = np.array([2, 3, 2, 3, 0, 1, 0, 1], dtype=np.int64)
        self.assertTrue(np.array_equal(ridx, exp_ridx))
...
class TestMultiIndex(unittest.TestCase):
    ...
    def test_constructor_single_level(self):
        single_level = MultiIndex(levels=[['foo', 'bar', 'baz', 'qux']],
                                  labels=[[0, 1, 2, 3]],
                                  names=['first'])
        self.assertTrue(isinstance(single_level, Index))
        self.assertTrue(not isinstance(single_level, MultiIndex))
        self.assertTrue(single_level.name == 'first')

        single_level = MultiIndex(levels=[['foo', 'bar', 'baz', 'qux']],
                                  labels=[[0, 1, 2, 3]])
        self.assertTrue(single_level.name is None)
    ...
    def test_copy(self):
        ...
        self.assertTrue(i_copy.levels == self.index.levels)
        self.assertTrue(i_copy.levels is not self.index.levels)

        self.assertTrue(i_copy.labels == self.index.labels)
        self.assertTrue(i_copy.labels is not self.index.labels)

        self.assertTrue(i_copy.names == self.index.names)
        self.assertTrue(i_copy.names is not self.index.names)

        self.assertTrue(i_copy.sortorder == self.index.sortorder)
    ...
    def test_view(self):
        ...
        # Equal...but not the same object
        self.assertTrue(i_view.levels == self.index.levels)
        self.assertTrue(i_view.levels is not self.index.levels)

        self.assertTrue(i_view.labels == self.index.labels)
        self.assertTrue(i_view.labels is not self.index.labels)

        self.assertTrue(i_view.names == self.index.names)
        self.assertTrue(i_view.names is not self.index.names)
        self.assertTrue(i_view.sortorder == self.index.sortorder)
    ...
    def test_contains(self):
        self.assertTrue(('foo', 'two') in self.index)
        self.assertTrue(('bar', 'two') not in self.index)
        self.assertTrue(None not in self.index)

    def test_is_all_dates(self):
        self.assertTrue(not self.index.is_all_dates)

    def test_is_numeric(self):
        # MultiIndex is never numeric
        self.assertTrue(not self.index.is_numeric())
    ...
    def test_get_loc(self):
        self.assertTrue(self.index.get_loc(('foo', 'two')) == 1)
        self.assertTrue(self.index.get_loc(('baz', 'two')) == 3)
        ...
        self.assertTrue(index.get_loc((2, 0)) == slice(3, 5))
    ...
    def test_consistency(self):
        ...
        self.assertTrue(not index.is_unique)
    ...
    def test_truncate(self):
        ...
        self.assertTrue('foo' not in result.levels[0])
        self.assertTrue(1 in result.levels[0])

        result = index.truncate(after=1)
        self.assertTrue(2 not in result.levels[0])
        self.assertTrue(1 in result.levels[0])
    ...
    def test_equals(self):
        ...
        self.assertTrue(not self.index.equals(self.index[:-1]))
        ...
        self.assertTrue(not index.equals(index2))
        self.assertTrue(not index.equal_levels(index2))
        ...
        index = MultiIndex(levels=[major_axis, minor_axis],
                           labels=[major_labels, minor_labels])
        self.assertTrue(not self.index.equals(index))
        self.assertTrue(not self.index.equal_levels(index))
    ...
    def test_union(self):
        ...
        self.assertTrue(the_union is self.index)
    ...
    def test_intersection(self):
        ...
        self.assertTrue(the_int is self.index)
    ...
    def test_insert(self):
        ...
        self.assertTrue(new_index[0] == ('bar', 'two'))

        # key not contained in all levels
        new_index = self.index.insert(0, ('abc', 'three'))
        self.assertTrue(np.array_equal(new_index.levels[0],
                                    list(self.index.levels[0]) + ['abc']))
        self.assertTrue(np.array_equal(new_index.levels[1],
                                    list(self.index.levels[1]) + ['three']))
        self.assertTrue(new_index[0] == ('abc', 'three'))
    ...
    def test_join_level(self):
        def _check_how(other, how):
            ...
            self.assertTrue(np.array_equal(join_index.values, exp_values))
            ...
            if how in ('outer', 'inner'):
                ...
                self.assertTrue(np.array_equal(lidx, lidx2))
                self.assertTrue(np.array_equal(ridx, ridx2))
                self.assertTrue(np.array_equal(join_index2.values, exp_values))
    ...
    def test_reindex(self):
        ...
        self.assertTrue(isinstance(result, MultiIndex))
        self.assertTrue(indexer is None)
    ...
    def test_reindex_level(self):
        ...
        self.assertTrue(np.array_equal(indexer, exp_indexer))

        self.assertTrue(target2.equals(exp_index2))
        exp_indexer2 = np.array([0, -1, 0, -1, 0, -1])
        self.assertTrue(np.array_equal(indexer2, exp_indexer2))
    ...
    def test_has_duplicates(self):
        self.assertTrue(not self.index.has_duplicates)
