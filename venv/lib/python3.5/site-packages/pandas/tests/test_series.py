...
class CheckNameIntegration(object):
    ...
    def test_name_printing(self):
        ...
        s = Series([0, 1, 2])
        s.name = "test"
        self.assertTrue("Name: test" in repr(s))
        s.name = None
        self.assertTrue(not "Name:" in repr(s))
...
class TestNanops(unittest.TestCase):
    ...
    def test_sum_zero(self):
        arr = np.array([])
        self.assertTrue(nanops.nansum(arr) == 0)
...
class TestSeries(unittest.TestCase, CheckNameIntegration):
    ...
    def test_constructor(self):
        ...
        self.assertTrue(isinstance(derived, TimeSeries))
        ...
        # Pass in scalar
        scalar = Series(0.5)
        self.assertTrue(isinstance(scalar, float))

        # Mixed type Series
        mixed = Series(['hello', np.NaN], index=[0, 1])
        self.assertTrue(mixed.dtype == np.object_)
        self.assertTrue(mixed[1] is np.NaN)

        self.assertTrue(not isinstance(self.empty, TimeSeries))
        self.assertTrue(not isinstance(Series({}), TimeSeries))
    ...
    def test_constructor_subclass_dict(self):
        ...
        series = Series(data)
        refseries = Series(dict(iter(data.items())))
    ...
    def test_fromDict(self):
        ...
        series = Series(data)
        self.assertTrue(series.dtype == np.object_)
        ...
        self.assertTrue(series.dtype == np.float64)
    ...
    def test_setindex(self):
        ...
        self.assertTrue(isinstance(series.index, Index))
    ...
    def test_fromValue(self):
        ...
        self.assertTrue(nans.dtype == np.float_)
        self.assertEqual(len(nans), len(self.ts))

        strings = Series('foo', index=self.ts.index)
        self.assertTrue(strings.dtype == np.object_)
        self.assertEqual(len(strings), len(self.ts))

        d = datetime.now()
        dates = Series(d, index=self.ts.index)
        self.assertTrue(dates.dtype == 'M8[ns]')
    ...
    def test_getitem_get(self):
        ...
        self.assertTrue(self.series.get(-1) is None)
    ...
    def test_getitem_boolean(self):
        ...
        expected = s[mask]
        assert_series_equal(result, expected)
        self.assertTrue(np.array_equal(result.index, s.index[mask]))
    ...
    def test_slice(self):
        ...
        self.assertTrue(self.series.index[9] not in numSlice.index)
        self.assertTrue(self.objSeries.index[9] not in objSlice.index)
    ...
    def test_slice_float_get_set(self):
        ...
        self.ts[4.0:10.0] = 0
        self.assertTrue((self.ts[4:10] == 0).all())
    ...
    def test_slice_floats2(self):
        ...
        self.assertTrue(len(s.ix[12.0:]) == 8)
        self.assertTrue(len(s.ix[12.5:]) == 7)
    ...
    def test_setitem(self):
        ...
        self.assertTrue(not np.isnan(self.ts[2]))
    ...
    def test_set_value(self):
        ...
        self.assertTrue(res is self.ts)
        self.assertEqual(self.ts[idx], 0)

        res = self.series.set_value('foobar', 0)
        self.assertTrue(res is not self.series)
    ...
    def test_reshape_2d_return_array(self):
        ...
        self.assertTrue(not isinstance(result, Series))
    ...
    def test_repr(self):
        ...
        rep_str = repr(ser)
        self.assertTrue("Name: 0" in rep_str)
    ...
    def test_keys(self):
        ...
        self.assertTrue(getkeys() is self.ts.index)

    def test_values(self):
        self.assertTrue(np.array_equal(self.ts, self.ts.values))
    ...
    def test_argsort(self):
        ...
        self.assertTrue(s.dtype == 'datetime64[ns]')
        shifted = s.shift(-1)
        self.assertTrue(shifted.dtype == 'datetime64[ns]')
        self.assertTrue(isnull(shifted[4]) == True)
    ...
    def test_argsort_stable(self):
        ...
        self.assertTrue(np.array_equal(mindexer, mexpected))
        self.assertTrue(np.array_equal(qindexer, qexpected))
        self.assertTrue(not np.array_equal(qindexer, mindexer))
    ...
    def test_cummin(self):
        self.assertTrue(np.array_equal(self.ts.cummin(),
    ...
    def test_cummax(self):
        self.assertTrue(np.array_equal(self.ts.cummax(),
    ...
    def _check_accum_op(self, name):
        ...
        self.assertTrue(np.array_equal(func(self.ts), func(np.array(self.ts))))
    ...
    def test_all_any(self):
        ...
        bool_series = ts > 0
        self.assertTrue(not bool_series.all())
    ...
    def test_constructor_dtype_timedelta64(self):
        ...
        self.assertTrue(td.dtype=='timedelta64[ns]')
        ...
        self.assertTrue(td.dtype=='object')
    ...
    def test_operators_timedelta64(self):
        ...
        assert_series_equal(rs, xp)
        self.assertTrue(rs.dtype=='timedelta64[ns]')
        ...
        self.assertTrue(result.dtype=='timedelta64[ns]')

        result = df['A'] + td
        self.assertTrue(result.dtype=='M8[ns]')

        # scalar Timestamp on rhs
        maxa = df['A'].max()
        self.assertTrue(isinstance(maxa,Timestamp))

        resultb = df['A']- df['A'].max()
        self.assertTrue(resultb.dtype=='timedelta64[ns]')
        ...
        resulta = df['A'] - d
        self.assertTrue(resulta.dtype=='m8[ns]')
        ...
        self.assertTrue(resultb.dtype=='M8[ns]')
    ...
    def test_timedelta64_nan(self):
        ...
        td1 = td.copy()
        td1[0] = np.nan
        self.assertTrue(isnull(td1[0]) == True)
        self.assertTrue(td1[0].view('i8') == tslib.iNaT)
        td1[0] = td[0]
        self.assertTrue(isnull(td1[0]) == False)

        td1[1] = tslib.iNaT
        self.assertTrue(isnull(td1[1]) == True)
        self.assertTrue(td1[1].view('i8') == tslib.iNaT)
        td1[1] = td[1]
        self.assertTrue(isnull(td1[1]) == False)

        td1[2] = tslib.NaT
        self.assertTrue(isnull(td1[2]) == True)
        self.assertTrue(td1[2].view('i8') == tslib.iNaT)
        td1[2] = td[2]
        self.assertTrue(isnull(td1[2]) == False)
    ...
    def test_operators_corner(self):
        ...
        self.assertTrue(np.array_equal(added[:-5], expected))
    ...
    def test_combine_first(self):
        ...
        self.assertTrue(np.array_equal(combined, series))

        # Holes filled from input
        combined = series_copy.combine_first(series)
        self.assertTrue(np.isfinite(combined).all())

        self.assertTrue(np.array_equal(combined[::2], series[::2]))
        self.assertTrue(np.array_equal(combined[1::2], series_copy[1::2]))
    ...
    def test_value_counts_nunique(self):
        ...
        import io
        import pandas as pd
        f = io.StringIO("xxyyzz20100101PIE\nxxyyzz20100101GUM\nxxyyww20090101EGG\nfoofoo20080909PIE")
        ...
        self.assertTrue(result.index.dtype == 'int64')
    ...
    def test_sort(self):
        ...
        self.assertTrue(np.array_equal(ts, self.ts.order()))
        self.assertTrue(np.array_equal(ts.index, self.ts.order().index))

        ts.sort(ascending=False)
        self.assertTrue(np.array_equal(ts, self.ts.order(ascending=False)))
        self.assertTrue(np.array_equal(ts.index,
    ...
    def test_order(self):
        ...
        self.assertTrue(np.array_equal(result[:-5], np.sort(vals[5:])))
    ...
    def test_to_dict(self):
        self.assertTrue(np.array_equal(Series(self.ts.to_dict()), self.ts))
    ...
    def test_clip(self):
        ...
        assert_series_equal(result, expected)
        self.assertTrue(isinstance(expected, Series))
    ...
    def test_astype_cast_object_int(self):
        ...
        self.assertTrue(np.array_equal(result, np.arange(1, 5)))
    ...
    def test_map(self):
        ...
        self.assertTrue(np.array_equal(result, self.ts * 2))

    def test_map_int(self):
        left = Series({'a': 1., 'b': 2., 'c': 3., 'd': 4})
        right = Series({1: 11, 2: 22, 3: 33})

        self.assertTrue(left.dtype == np.float_)
        self.assertTrue(issubclass(right.dtype.type, np.integer))

        merged = left.map(right)
        self.assertTrue(merged.dtype == np.float_)
    ...
    def test_apply_args(self):
        ...
        self.assertTrue(result[0] == ['foo', 'bar'])
    ...
    def test_align_sameindex(self):
        ...
        self.assertTrue(a.index is self.ts.index)
        self.assertTrue(b.index is self.ts.index)
    ...
    def test_reindex_int(self):
        ...
        # if NaNs introduced
        self.assertTrue(reindexed_int.dtype == np.float_)

        # NO NaNs introduced
        reindexed_int = int_ts.reindex(int_ts.index[::2])
        self.assertTrue(reindexed_int.dtype == np.int_)
    ...
    def test_reindex_bool(self):
        ...
        # if NaNs introduced
        self.assertTrue(reindexed_bool.dtype == np.object_)

        # NO NaNs introduced
        reindexed_bool = bool_ts.reindex(bool_ts.index[::2])
        self.assertTrue(reindexed_bool.dtype == np.bool_)
    ...
    def test_rename(self):
        ...
        # dict
        rename_dict = dict(list(zip(self.ts.index, renamed.index)))
        ...
        self.assertTrue(np.array_equal(renamed.index, ['a', 'foo', 'c', 'bar']))
...
# TimeSeries-specific
    ...
    def test_fillna(self):
        ...
        self.assertTrue(np.array_equal(ts, ts.fillna(method='ffill')))

        ts[2] = np.NaN

        self.assertTrue(
            np.array_equal(ts.fillna(method='ffill'), [0., 1., 1., 3., 4.]))
        self.assertTrue(np.array_equal(ts.fillna(method='backfill'),
                                    [0., 1., 3., 3., 4.]))

        self.assertTrue(np.array_equal(ts.fillna(value=5), [0., 1., 5., 3., 4.]))
    ...
    def test_asfreq(self):
        ...
        self.assertTrue(np.array_equal(monthly_ts, ts))
        ...
        self.assertTrue(len(result) == 0)
        self.assertTrue(result is not ts)
    ...
    def test_interpolate(self):
        ...
        self.assertTrue(np.array_equal(linear_interp, ts))
        ...
        self.assertTrue(np.array_equal(time_interp, ord_ts))
    ...
    def test_first_last_valid(self):
        ...
        ts[:] = np.nan
        self.assertTrue(ts.last_valid_index() is None)
        self.assertTrue(ts.first_valid_index() is None)

        ser = Series([], index=[])
        self.assertTrue(ser.last_valid_index() is None)
        self.assertTrue(ser.first_valid_index() is None)
...
class TestSeriesNonUnique(unittest.TestCase):
    ...
    def test_reset_index(self):
        ...
        ser.name = 'value'
        df = ser.reset_index()
        self.assertTrue('value' in df)

        df = ser.reset_index(name='value2')
        self.assertTrue('value2' in df)
    ...
    def test_timeseries_coercion(self):
        ...
        self.assertTrue(isinstance(ser, TimeSeries))
        self.assertTrue(isinstance(ser.index, DatetimeIndex))
