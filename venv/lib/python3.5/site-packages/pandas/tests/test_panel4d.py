...
class SafeForSparse(object):
    ...
    def test_set_axis(self):
        ...
        if hasattr(self.panel4d, '_item_cache'):
            self.assertTrue('l1' not in self.panel4d._item_cache)
        self.assertTrue(self.panel4d.labels is new_labels)

        self.panel4d.major_axis = new_major
        self.assertTrue(self.panel4d[0].major_axis is new_major)
        self.assertTrue(self.panel4d.major_axis is new_major)

        self.panel4d.minor_axis = new_minor
        self.assertTrue(self.panel4d[0].minor_axis is new_minor)
        self.assertTrue(self.panel4d.minor_axis is new_minor)
...
class CheckIndexing(object):
    ...
    def test_delitem_and_pop(self):
        ...
        self.assertTrue('l2' not in self.panel4d.labels)

        del self.panel4d['l3']
        self.assertTrue('l3' not in self.panel4d.labels)
    ...
    def test_setitem(self):
        ...
        self.assertTrue(self.panel4d['lG'].values.dtype == np.int64)
        self.assertTrue(self.panel4d['lE'].values.dtype == np.bool_)

        # object dtype
        self.panel4d['lQ'] = 'foo'
        self.assertTrue(self.panel4d['lQ'].values.dtype == np.object_)

        # boolean dtype
        self.panel4d['lP'] = self.panel4d['l1'] > 0
        self.assertTrue(self.panel4d['lP'].values.dtype == np.bool_)
    ...
    def test_major_xs_mixed(self):
        ...
        self.assertTrue(xs['l1']['A'].dtype == np.float64)
        self.assertTrue(xs['l4']['A'].dtype == np.object_)
    ...
    def test_minor_xs_mixed(self):
        ...
        self.assertTrue(xs['l1'].T['ItemA'].dtype == np.float64)
        self.assertTrue(xs['l4'].T['ItemA'].dtype == np.object_)
    ...
    def test_xs(self):
        ...
        # not view by default
        l1.values[:] = np.nan
        self.assertTrue(not np.isnan(self.panel4d['l1'].values).all())
    ...
    def test_set_value(self):
        ...
        self.assertTrue(isinstance(res, Panel4D))
        self.assertTrue(res is not self.panel4d)
...
class TestPanel4d(unittest.TestCase, CheckIndexing, SafeForSparse,
    ...
    def test_constructor(self):
        ...
        self.assertTrue(panel4d._data is self.panel4d._data)

        panel4d = Panel4D(self.panel4d._data, copy=True)
        self.assertTrue(panel4d._data is not self.panel4d._data)
        ...
        self.assertTrue(panel4d.values is vals)

        # copy
        panel4d = Panel4D(vals, copy=True)
        self.assertTrue(panel4d.values is not vals)
    ...
    def test_consolidate(self):
        ...
        self.panel4d['foo'] = 1.
        self.assertTrue(not self.panel4d._data.is_consolidated())
    ...
    def test_swapaxes(self):
        ...
        self.assertTrue(result.items is self.panel4d.labels)

        result = self.panel4d.swapaxes('labels', 'minor')
        self.assertTrue(result.labels is self.panel4d.minor_axis)

        result = self.panel4d.swapaxes('items', 'minor')
        self.assertTrue(result.items is self.panel4d.minor_axis)

        result = self.panel4d.swapaxes('items', 'major')
        self.assertTrue(result.items is self.panel4d.major_axis)

        result = self.panel4d.swapaxes('major', 'minor')
        self.assertTrue(result.major_axis is self.panel4d.minor_axis)

        # this should also work
        result = self.panel4d.swapaxes(0, 1)
        self.assertTrue(result.labels is self.panel4d.items)
