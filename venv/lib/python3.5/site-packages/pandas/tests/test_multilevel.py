...
class TestMultiLevel(unittest.TestCase):
    ...
    def test_dataframe_constructor(self):
        multi = DataFrame(np.random.randn(4, 4),
                          index=[np.array(['a', 'a', 'b', 'b']),
                                 np.array(['x', 'y', 'x', 'y'])])
        self.assertTrue(isinstance(multi.index, MultiIndex))
        self.assertTrue(not isinstance(multi.columns, MultiIndex))

        multi = DataFrame(np.random.randn(4, 4),
                          columns=[['a', 'a', 'b', 'b'],
                                   ['x', 'y', 'x', 'y']])
        self.assertTrue(isinstance(multi.columns, MultiIndex))
    ...
    def test_reindex_preserve_levels(self):
        ...
        self.assertTrue(chunk.index is new_index)
        ...
        self.assertTrue(chunk.columns is new_index)
...
x   q   30      3    -0.6662 -0.5243 -0.3580  0.89145  2.5838"""
    ...
    def test_setitem_change_dtype(self):
        ...
        self.assertTrue(isinstance(dft._data.blocks[1].items, MultiIndex))
    ...
    def test_reset_index_with_drop(self):
        ...
        self.assertTrue(isinstance(deleveled, DataFrame))
        self.assertTrue(
            len(deleveled.columns) == len(self.series.index.levels) + 1)

        deleveled = self.series.reset_index(drop=True)
        self.assertTrue(isinstance(deleveled, Series))
...
Thur,Lunch,Yes,51.51,17"""
    ...
    def test_stack_mixed_dtype(self):
        ...
        self.assertTrue(stacked['bar'].dtype == np.float_)
    ...
    def test_join(self):
        ...
        self.assertTrue(not np.isnan(joined.values).all())
    ...
    def test_swaplevel(self):
        ...
        self.assertTrue(not swapped.index.equals(self.frame.index))
    ...
    def test_insert_index(self):
        ...
        self.assertTrue(isinstance(df.columns, MultiIndex))
    ...
    def test_is_lexsorted(self):
        ...
        index = MultiIndex(levels=levels,
                           labels=[[0, 0, 0, 1, 1, 1],
                                   [0, 1, 2, 0, 2, 1]])
        self.assertTrue(not index.is_lexsorted())

        index = MultiIndex(levels=levels,
                           labels=[[0, 0, 1, 0, 1, 1],
                                   [0, 1, 0, 2, 2, 1]])
        self.assertTrue(not index.is_lexsorted())
        self.assertTrue(index.lexsort_depth == 0)
    ...
    def test_unstack_preserve_types(self):
        ...
        self.assertTrue(unstacked['A', 1].dtype == np.float64)
        self.assertTrue(unstacked['E', 1].dtype == np.object_)
        self.assertTrue(unstacked['F', 1].dtype == np.float64)
    ...
    def test_int_series_slicing(self):
        ...
        s[5:] = 0
        exp.values[5:] = 0
        self.assertTrue(np.array_equal(s.values, exp.values))
    ...
    def test_drop_preserve_names(self):
        ...
        result = df.drop([(0, 2)])
        self.assertTrue(result.index.names == ['one', 'two'])
