...
class TestIndexing(unittest.TestCase):
    ...
    def test_setitem_dtype_upcast(self):
        ...
        df['c'] = np.nan
        self.assertTrue(df['c'].dtype == np.float64)
    ...
    def test_dups_fancy_indexing(self):
        ...
        rows = ['C', 'B']
        res = df.ix[rows]
        self.assertTrue(rows == list(res.index))

        res = df.ix[Index(rows)]
        self.assertTrue(Index(rows).equals(res.index))
    ...
    def test_iloc_panel_issue(self):
        ...
        self.assertTrue(p.iloc[:3, :3, :3].shape == (3,3,3))
        self.assertTrue(p.iloc[1, :3, :3].shape == (3,3))
        self.assertTrue(p.iloc[:3, 1, :3].shape == (3,3))
        self.assertTrue(p.iloc[:3, :3, 1].shape == (3,3))
        self.assertTrue(p.iloc[1, 1, :3].shape == (3,))
        self.assertTrue(p.iloc[1, :3, 1].shape == (3,))
        self.assertTrue(p.iloc[:3, 1, 1].shape == (3,))
    ...
    def test_loc_name(self):
        ...
        self.assertTrue(result == 'index_name')
...
"""
    ...
    def test_non_unique_loc_memory_error(self):
        ...
        df = gen_test(900,100)
        self.assertTrue(not df.index.is_unique)
