...
class SafeForSparse(object):
    ...
    def test_set_axis(self):
        ...
        if hasattr(self.panel, '_item_cache'):
            self.assertTrue('ItemA' not in self.panel._item_cache)
        self.assertTrue(self.panel.items is new_items)

        item = self.panel[0]
        self.panel.major_axis = new_major
        self.assertTrue(self.panel[0].index is new_major)
        self.assertTrue(self.panel.major_axis is new_major)

        item = self.panel[0]
        self.panel.minor_axis = new_minor
        self.assertTrue(self.panel[0].columns is new_minor)
        self.assertTrue(self.panel.minor_axis is new_minor)
...
class CheckIndexing(object):
    ...
    def test_delitem_and_pop(self):
        ...
        self.assertTrue('ItemA' not in self.panel.items)

        del self.panel['ItemB']
        self.assertTrue('ItemB' not in self.panel.items)
    ...
    def test_setitem(self):
        ...
        self.assertTrue(self.panel['ItemG'].values.dtype == np.int64)
        self.assertTrue(self.panel['ItemE'].values.dtype == np.bool_)

        # object dtype
        self.panel['ItemQ'] = 'foo'
        self.assertTrue(self.panel['ItemQ'].values.dtype == np.object_)

        # boolean dtype
        self.panel['ItemP'] = self.panel['ItemA'] > 0
        self.assertTrue(self.panel['ItemP'].values.dtype == np.bool_)
    ...
    def test_major_xs_mixed(self):
        ...
        xs = self.panel.major_xs(self.panel.major_axis[0])
        self.assertTrue(xs['ItemA'].dtype == np.float64)
        self.assertTrue(xs['ItemD'].dtype == np.object_)
    ...
    def test_xs(self):
        ...
        # not view by default
        itemA.values[:] = np.nan
        self.assertTrue(not np.isnan(self.panel['ItemA'].values).all())
    ...
    def test_set_value(self):
        ...
        self.assertTrue(isinstance(res, Panel))
...
class TestPanel(unittest.TestCase, PanelTests, CheckIndexing,
    ...
    def test_constructor(self):
        ...
        self.assertTrue(wp._data is self.panel._data)

        wp = Panel(self.panel._data, copy=True)
        self.assertTrue(wp._data is not self.panel._data)
        assert_panel_equal(wp, self.panel)

        # strings handled prop
        wp = Panel([[['foo', 'foo', 'foo', ],
                     ['foo', 'foo', 'foo']]])
        self.assertTrue(wp.values.dtype == np.object_)

        vals = self.panel.values

        # no copy
        wp = Panel(vals)
        self.assertTrue(wp.values is vals)

        # copy
        wp = Panel(vals, copy=True)
        self.assertTrue(wp.values is not vals)
    ...
    def test_constructor_observe_dtype(self):
        ...
        self.assertTrue(panel.values.dtype == np.object_)
    ...
    def test_constructor_dtypes(self):
        ...
        def _check_dtype(panel, dtype):
            for i in panel.items:
                self.assertTrue(panel[i].values.dtype.name == dtype)
    ...
    def test_consolidate(self):
        ...
        self.panel['foo'] = 1.
        self.assertTrue(not self.panel._data.is_consolidated())
    ...
    def test_from_dict_mixed_orient(self):
        ...
        self.assertTrue(panel['foo'].values.dtype == np.object_)
        self.assertTrue(panel['A'].values.dtype == np.float64)
    ...
    def test_swapaxes(self):
        ...
        self.assertTrue(result.items is self.panel.minor_axis)

        result = self.panel.swapaxes('items', 'major')
        self.assertTrue(result.items is self.panel.major_axis)

        result = self.panel.swapaxes('major', 'minor')
        self.assertTrue(result.major_axis is self.panel.minor_axis)
...
class TestLongPanel(unittest.TestCase):
    ...
    def test_axis_dummies(self):
        ...
        self.assertTrue(np.array_equal(transformed.columns, ['one', 'two']))
    ...
    def test_get_dummies(self):
        ...
        self.assertTrue(np.array_equal(dummies.values, minor_dummies.values))
