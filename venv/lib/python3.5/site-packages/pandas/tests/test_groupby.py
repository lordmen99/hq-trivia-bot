...
def commonSetUp(self):
    ...
    self.groupDict = dict((k, v) for k, v in self.groupId.items())
...
class TestGroupBy(unittest.TestCase):
    ...
    def test_first_last_nth_dtypes(self):
        ...
        self.assertTrue(s.dtype == 'int64')
        f = s.groupby(level=0).first()
        self.assertTrue(f.dtype == 'int64')
    ...
    def test_groups(self):
        ...
        self.assertTrue(groups is grouped.groups)  # caching works
    ...
    def test_frame_groupby(self):
        ...
        for weekday, group in grouped:
            self.assertTrue(group.index[0].weekday() == weekday)
    ...
    def test_frame_set_name_single(self):
        ...
        result = grouped.mean()
        self.assertTrue(result.index.name == 'A')
    ...
    def test_multi_iter(self):
        ...
        for i, ((one, two), three) in enumerate(iterated):
            e1, e2, e3 = expected[i]
            self.assertTrue(e1 == one)
            self.assertTrue(e2 == two)
    ...
    def test_groupby_multiple_columns(self):
        ...
        def _check_op(op):
            ...
            expected = dict((k, DataFrame(v)) for k, v in expected.items())
    ...
    def test_as_index_series_return_frame(self):
        ...
        self.assertTrue(isinstance(result2, DataFrame))
        assert_frame_equal(result2, expected2)
    ...
    def test_wrap_aggregated_output_multindex(self):
        ...
        self.assertTrue(isinstance(agged.columns, MultiIndex))
    ...
    def test_groupby_level(self):
        ...
        self.assertTrue(result0.index.name == 'first')
        self.assertTrue(result1.index.name == 'second')
    ...
    def test_groupby_level_apply(self):
        ...
        self.assertTrue(result.index.name == 'first')
        result = frame.groupby(level=1).count()
        self.assertTrue(result.index.name == 'second')
    ...
    def test_mutate_groups(self):
        ...
        mydf = DataFrame({
                ...
                'cat3' : ['g%s' % x for x in range(1,15)],
    ...
    def test_transform_mixed_type(self):
        ...
        self.assertTrue(result['d'].dtype == np.float64)
...
4,foo3,bar1,baz2,spam1,60"""
    ...
    def test_panel_groupby(self):
        ...
        self.assertTrue(np.array_equal(agged.items, [0, 1]))

        grouped = self.panel.groupby(lambda x: x.month, axis='major')
        agged = grouped.mean()

        self.assertTrue(np.array_equal(agged.major_axis, [1, 2]))

        grouped = self.panel.groupby({'A': 0, 'B': 0, 'C': 1, 'D': 1},
                                     axis='minor')
        agged = grouped.mean()
        self.assertTrue(np.array_equal(agged.minor_axis, [0, 1]))
    ...
    def test_groupby_2d_malformed(self):
        ...
        self.assertTrue(np.array_equal(tmp.columns, ['zeros', 'ones']))
        self.assertTrue(np.array_equal(tmp.values, res_values))
    ...
    def test_int64_overflow(self):
        ...
        for k, v in expected.items():
            self.assertTrue(left[k] == right[k[::-1]] == v)
        self.assertTrue(len(left) == len(right))
    ...
    def test_groupby_sort_multi(self):
        ...
        self.assertTrue(np.array_equal(result.index.values,
                                    tups[[1, 2, 0]]))

        tups = list(map(tuple, df[['c', 'a', 'b']].values))
        tups = com._asarray_tuplesafe(tups)
        result = df.groupby(['c', 'a', 'b'], sort=True).sum()
        self.assertTrue(np.array_equal(result.index.values, tups))
    ...
    def test_multifunc_sum_bug(self):
        ...
        self.assertTrue(result['fl'].dtype == np.float64)
    ...
    def test_agg_multiple_functions_maintain_order(self):
        ...
        self.assertTrue(np.array_equal(result.columns, exp_cols))
    ...
    def test_no_dummy_key_names(self):
        ...
        self.assertTrue(result.index.names == [None, None])
    ...
    def test_groupby_categorical(self):
        ...
        assert_frame_equal(result, expected)
        self.assertTrue(result.index.name == cats.name)
    ...
    def test_groupby_groups_datetimeindex(self):
        ...
        # it works!
        groups = grouped.groups
        self.assertTrue(isinstance(list(groups.keys())[0], datetime))
    ...
    def test_multiindex_columns_empty_level(self):
        ...
        self.assertTrue(np.array_equal(grouped['A'], [0]))
