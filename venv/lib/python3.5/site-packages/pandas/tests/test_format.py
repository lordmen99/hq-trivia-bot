...
class TestDataFrameFormatting(unittest.TestCase):
    ...
    def test_repr_tuples(self):
        ...
        df = DataFrame({'tups': list(zip(list(range(10)), list(range(10))))})
        repr(df)
    ...
    def test_to_string_repr_unicode(self):
        ...
        for line in rs[1:]:
            ...
            if not line.startswith('dtype:'):
                self.assertTrue(len(line) == line_len)
    ...
    def test_to_string_with_formatters_unicode(self):
        ...
        result = df.to_string(formatters={'c/\u03c3': lambda x: '%s' % x})
        self.assertEqual(result, ('  c/\u03c3\n'
                                  '0   1\n'
                                  '1   2\n'
                                  '2   3'))
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    def test_pprint_thing(self):
        ...
        self.assertEqual(pp_t('a') , 'a')
        self.assertEqual(pp_t('a') , 'a')
        self.assertEqual(pp_t(None) , 'None')
        self.assertEqual(pp_t('\u05d0',quote_strings=True) , "u'\u05d0'")
        self.assertEqual(pp_t('\u05d0',quote_strings=False) , '\u05d0')
        self.assertEqual(pp_t(('\u05d0', '\u05d1'),quote_strings=True) ,
                          "(u'\u05d0', u'\u05d1')")
        self.assertEqual(pp_t(('\u05d0', ('\u05d1', '\u05d2')),quote_strings=True) ,
               "(u'\u05d0', (u'\u05d1', u'\u05d2'))")
        self.assertEqual(pp_t(('foo', '\u05d0', ('\u05d0', '\u05d0')),quote_strings=True)
                          , "(u'foo', u'\u05d0', (u'\u05d0', u'\u05d0'))")
    ...
    def test_wide_repr(self):
        with option_context('mode.sim_interactive', True):
            ...
            wide_repr = repr(df)
            self.assertTrue(rep_str != wide_repr)
    ...
    def test_wide_repr_wide_columns(self):
        with option_context('mode.sim_interactive', True):
            ...
            self.assertTrue(len(rep_str.splitlines()) == 20)
    ...
    def test_wide_repr_named(self):
        with option_context('mode.sim_interactive', True):
            ...
            for line in wide_repr.splitlines()[1::13]:
                self.assertTrue('DataFrame Index' in line)
    ...
    def test_wide_repr_multiindex(self):
        with option_context('mode.sim_interactive', True):
            ...
            for line in wide_repr.splitlines()[1::13]:
                self.assertTrue('Level 0 Level 1' in line)
...
"""
    ...
    def test_to_html_columns_arg(self):
        ...
        self.assertTrue('<th>B</th>' not in result)
    ...
    def test_to_html_multiindex(self):
        ...
        columns = pandas.MultiIndex.from_tuples(list(zip(list(range(4)),
                                                    np.mod(list(range(4)), 2))))
        df = pandas.DataFrame([list('abcd'), list('efgh')], columns=columns)
    ...
    def test_to_html_index(self):
        ...
        for i in index:
            self.assertTrue(i not in result)
    ...
    def test_fake_qtconsole_repr_html(self):
        ...
        self.assertTrue(repstr is not None)

        fmt.set_option('display.max_rows', 5, 'display.max_columns', 2)
        repstr = self.frame._repr_html_()
        self.assertTrue('class' in repstr)  # info fallback
