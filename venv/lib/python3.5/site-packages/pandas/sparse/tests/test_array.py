...
class TestSparseArray(unittest.TestCase):
    ...
    def test_constructor_copy(self):
        ...
        cp.sp_values[:3] = 0
        self.assertTrue(not (self.arr.sp_values[:3] == 0).any())
    ...
    def test_astype(self):
        ...
        res.sp_values[:3] = 27
        self.assertTrue(not (self.arr.sp_values[:3] == 27).any())
    ...
    def test_binary_operators(self):
        ...
        def _check_op(op, first, second):
            ...
            self.assertTrue(isinstance(res, SparseArray))
            assert_almost_equal(res.values, exp.values)

            res2 = op(first, second.values)
            self.assertTrue(isinstance(res2, SparseArray))
            assert_sp_array_equal(res, res2)

            res3 = op(first.values, second)
            self.assertTrue(isinstance(res3, SparseArray))
            assert_sp_array_equal(res, res3)

            res4 = op(first, 4)
            self.assertTrue(isinstance(res4, SparseArray))
