...
class SparseDataFrame(DataFrame):
    ...
    def to_dense(self):
        ...
        df : DataFrame
        """
        data = dict((k, v.to_dense()) for k, v in self.items())
    ...
    def copy(self, deep=True):
        ...
        """
        series = dict((k, v.copy()) for k, v in self.items())
    ...
    def _set_index(self, index):
        ...
        for v in list(self._series.values()):
            v.index = self._index
    ...
    def _reindex_columns(self, columns, copy, level, fill_value, limit=None,
        ...
        sdict = dict((k, v) for k, v in self.items() if k in columns)
