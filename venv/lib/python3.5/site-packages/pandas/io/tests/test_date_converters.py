...
"""
        ...
        self.assertTrue('date_time' in df)
        self.assertTrue(df.date_time.ix[0] == datetime(2001, 1, 5, 10, 0, 0))
    ...
    def test_parse_date_fields(self):
        ...
        self.assertTrue('ymd' in df)
        self.assertTrue(df.ymd.ix[0] == datetime(2001, 1, 10))
...
"""
        ...
        self.assertTrue('ymdHMS' in df)
        self.assertTrue(df.ymdHMS.ix[0] == datetime(2001, 1, 5, 10, 0, 0))
...
"""
        ...
        self.assertTrue(df.ymdHMS.ix[0] == datetime(2001, 1, 5, 10, 0, 0,
                                                 microsecond=123456))
        self.assertTrue(df.ymdHMS.ix[1] == datetime(2001, 1, 5, 10, 0, 0,
                                                 microsecond=500000))
    ...
    def test_generic(self):
        ...
        self.assertTrue('ym' in df)
        self.assertTrue(df.ym.ix[0] == date(2001, 1, 1))
