...
class TestCParser(unittest.TestCase):
    ...
    def test_string_factorize(self):
        ...
        result = reader.read()
        self.assertTrue(len(set(map(id, result[0]))) == 2)
    ...
    def test_skipinitialspace(self):
        ...
        self.assertTrue(np.array_equal(result[0], ['a', 'a', 'a', 'a']))
        self.assertTrue(np.array_equal(result[1], ['b', 'b', 'b', 'b']))
    ...
    def test_parse_booleans(self):
        ...
        self.assertTrue(result[0].dtype == np.bool_)
    ...
    def test_delimit_whitespace(self):
        ...
        self.assertTrue(np.array_equal(result[0], ['a', 'a', 'a']))
        self.assertTrue(np.array_equal(result[1], ['b', 'b', 'b']))
    ...
    def test_embedded_newline(self):
        ...
        expected = ['a', 'hello\nthere', 'this']
        self.assertTrue(np.array_equal(result[0], expected))
...
aaaaa,5"""
        ...
        self.assertTrue(result[0].dtype == 'S5')

        ex_values = np.array(['a', 'aa', 'aaa', 'aaaa', 'aaaaa'], dtype='S5')
        self.assertTrue((result[0] == ex_values).all())
        self.assertTrue(result[1].dtype == 'i4')

        reader = _make_reader(dtype='S4')
        result = reader.read()
        self.assertTrue(result[0].dtype == 'S4')
        ex_values = np.array(['a', 'aa', 'aaa', 'aaaa', 'aaaa'], dtype='S4')
        self.assertTrue((result[0] == ex_values).all())
        self.assertTrue(result[1].dtype == 'S4')
...
4,d"""
        ...
        result = reader.read()
        self.assertTrue(result[0].dtype == 'u1')
        self.assertTrue(result[1].dtype == 'S1')

        reader = _make_reader(dtype={'one': np.uint8, 1: object})
        result = reader.read()
        self.assertTrue(result[0].dtype == 'u1')
        self.assertTrue(result[1].dtype == 'O')
