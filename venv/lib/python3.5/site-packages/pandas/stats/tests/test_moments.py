...
class TestMoments(unittest.TestCase):
    ...
    def _check_ndarray(self, func, static_comp, window=50,
        ...
        if has_min_periods:
            ...
            self.assertTrue(not np.isnan(result[24]))

            self.assertTrue(not np.isnan(result[-6]))
    ...
    def _check_structures(self, func, static_comp,
        ...
        self.assertTrue(isinstance(series_result, Series))
    ...
    def _check_ew_ndarray(self, func, preserve_nan=False):
        ...
        self.assertTrue(result2.dtype == np.float_)
    ...
    def _check_binary_ew(self, func):
        ...
        self.assertTrue(not np.isnan(result.values[15:]).any())
    ...
    def _check_expanding_ndarray(self, func, static_comp, has_min_periods=True,
        ...
        if has_min_periods:
            ...
            self.assertTrue(not np.isnan(result[14]))
